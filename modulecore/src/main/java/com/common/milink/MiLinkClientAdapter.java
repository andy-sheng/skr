...
import com.common.milink.callback.MiLinkChannelStatusObserver;
import com.common.milink.callback.MiLinkEventListener;
...
//        mMiLinkChannelClient.setEventListener(mMiLinkEventListener);
    ...
    private static class MiLinkClientAdapterHolder {
        private static final MiLinkClientAdapter INSTANCE = new MiLinkClientAdapter();
    }

    public static final MiLinkClientAdapter getInstance() {
        return MiLinkClientAdapterHolder.INSTANCE;
    }
