...
public class EmptyView extends RelativeLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        inflate(context, R.layout.core_empty_view_inside, this);
        String tips = U.app().getResources().getString(R.string.core_empty_tips);
        Drawable emptyIcon = U.app().getResources().getDrawable(R.drawable.loading_empty);
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.EmptyView);
            emptyIcon = ta.getDrawable(R.styleable.EmptyView_core_emptyIcon);
            mEmptyDrawable = ta.getResourceId(R.styleable.EmptyView_core_emptyIcon, R.drawable.loading_empty);
            tips = ta.getString(R.styleable.EmptyView_core_emptyTips);
            ta.recycle();
        }
