...
/** 
 * DAO for table "MY_USER_INFO".
*/
public class MyUserInfoDao extends AbstractDao<MyUserInfo, Long> {

    public static final String TABLENAME = "MY_USER_INFO";

    /**
     * Properties of entity MyUserInfo.<br/>
    ...
    public MyUserInfoDao(DaoConfig config) {
        super(config);
    }
    
    public MyUserInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MY_USER_INFO\" (" + //
                ...
                "\"EXT\" TEXT);"); // 40: ext
        // Add Indexes
        db.execSQL("CREATE UNIQUE INDEX " + constraint + "IDX_MY_USER_INFO_UID_DESC ON MY_USER_INFO" +
                " (\"UID\" DESC);");
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"MY_USER_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, MyUserInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MyUserInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public MyUserInfo readEntity(Cursor cursor, int offset) {
        MyUserInfo entity = new MyUserInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, MyUserInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MyUserInfo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MyUserInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MyUserInfo entity) {
