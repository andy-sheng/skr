 ...
 * 查询粉丝列表
 */
public final class FollowerListRequest extends Message<FollowerListRequest, FollowerListRequest.Builder> {
  public static final ProtoAdapter<FollowerListRequest> ADAPTER = new ProtoAdapter_FollowerListRequest();
  ...
  public FollowerListRequest(Long userId, Integer offset, Integer limit) {
    this(userId, offset, limit, ByteString.EMPTY);
  }

  public FollowerListRequest(Long userId, Integer offset, Integer limit, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof FollowerListRequest)) return false;
    FollowerListRequest o = (FollowerListRequest) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "FollowerListRequest{").append('}').toString();
  }

  public byte[] toByteArray() {
    return FollowerListRequest.ADAPTER.encode(this);
  }
  ...
  public static final class Builder extends Message.Builder<FollowerListRequest, Builder> {
    ...
    public FollowerListRequest build() {
      ...
      return new FollowerListRequest(userId, offset, limit, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_FollowerListRequest extends ProtoAdapter<FollowerListRequest> {
    public ProtoAdapter_FollowerListRequest() {
      super(FieldEncoding.LENGTH_DELIMITED, FollowerListRequest.class);
    }

    @Override
    public int encodedSize(FollowerListRequest value) {
    ...
    @Override
    public void encode(ProtoWriter writer, FollowerListRequest value) throws IOException {
    ...
    @Override
    public FollowerListRequest decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public FollowerListRequest redact(FollowerListRequest value) {
