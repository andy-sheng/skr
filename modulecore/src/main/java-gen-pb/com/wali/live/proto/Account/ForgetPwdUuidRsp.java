...
public final class ForgetPwdUuidRsp extends Message<ForgetPwdUuidRsp, ForgetPwdUuidRsp.Builder> {
  public static final ProtoAdapter<ForgetPwdUuidRsp> ADAPTER = new ProtoAdapter_ForgetPwdUuidRsp();
  ...
  public ForgetPwdUuidRsp(Integer retCode, Long uuid, String serviceToken, String securityKey,
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ForgetPwdUuidRsp)) return false;
    ForgetPwdUuidRsp o = (ForgetPwdUuidRsp) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "ForgetPwdUuidRsp{").append('}').toString();
  }

  public static final ForgetPwdUuidRsp parseFrom(byte[] data) throws IOException {
    ForgetPwdUuidRsp c = null;
       c = ForgetPwdUuidRsp.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<ForgetPwdUuidRsp, Builder> {
    ...
    @Override
    public ForgetPwdUuidRsp build() {
      return new ForgetPwdUuidRsp(retCode, uuid, serviceToken, securityKey, passToken, nickname, headinfo, sex, hasInnerAvatar, hasInnerNickname, hasInnerSex, errMsg, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_ForgetPwdUuidRsp extends ProtoAdapter<ForgetPwdUuidRsp> {
    public ProtoAdapter_ForgetPwdUuidRsp() {
      super(FieldEncoding.LENGTH_DELIMITED, ForgetPwdUuidRsp.class);
    }

    @Override
    public int encodedSize(ForgetPwdUuidRsp value) {
    ...
    @Override
    public void encode(ProtoWriter writer, ForgetPwdUuidRsp value) throws IOException {
    ...
    @Override
    public ForgetPwdUuidRsp decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public ForgetPwdUuidRsp redact(ForgetPwdUuidRsp value) {
