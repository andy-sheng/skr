...
public final class HisLive extends Message<HisLive, HisLive.Builder> {
  ...
  @WireField(
      tag = 8,
      adapter = "com.wali.live.proto.RoomInfo.LiveCover#ADAPTER"
  )
  ...
  public HisLive(String liveId, Integer viewerCnt, String url, Long startTime, Long endTime,
      String liveTitle, String shareUrl, LiveCover liveCover, Integer type, String password,
      TicketLiveStatus ticketStatus) {
    this(liveId, viewerCnt, url, startTime, endTime, liveTitle, shareUrl, liveCover, type, password, ticketStatus, ByteString.EMPTY);
  }
  ...
  public static final class Builder extends Message.Builder<HisLive, Builder> {
    ...
    public HisLive build() {
      return new HisLive(liveId, viewerCnt, url, startTime, endTime, liveTitle, shareUrl, liveCover, type, password, ticketStatus, super.buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_HisLive extends ProtoAdapter<HisLive> {
    ...
    public int encodedSize(HisLive value) {
      return ProtoAdapter.STRING.encodedSizeWithTag(1, value.liveId)
          ...
          + ProtoAdapter.STRING.encodedSizeWithTag(10, value.password)
          + TicketLiveStatus.ADAPTER.encodedSizeWithTag(11, value.ticketStatus)
    ...
    public void encode(ProtoWriter writer, HisLive value) throws IOException {
      ...
      ProtoAdapter.STRING.encodeWithTag(writer, 10, value.password);
      TicketLiveStatus.ADAPTER.encodeWithTag(writer, 11, value.ticketStatus);
    ...
    public HisLive decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 10: builder.setPassword(ProtoAdapter.STRING.decode(reader)); break;
          case 11: builder.setTicketStatus(TicketLiveStatus.ADAPTER.decode(reader)); break;
          default: {
