...
public final class ForgetPwdRsp extends Message<ForgetPwdRsp, ForgetPwdRsp.Builder> {
  public static final ProtoAdapter<ForgetPwdRsp> ADAPTER = new ProtoAdapter_ForgetPwdRsp();
  ...
  public ForgetPwdRsp(Integer retCode, Long uuid, String serviceToken, String securityKey,
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof ForgetPwdRsp)) return false;
    ForgetPwdRsp o = (ForgetPwdRsp) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "ForgetPwdRsp{").append('}').toString();
  }

  public static final ForgetPwdRsp parseFrom(byte[] data) throws IOException {
    ForgetPwdRsp c = null;
       c = ForgetPwdRsp.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<ForgetPwdRsp, Builder> {
    ...
    @Override
    public ForgetPwdRsp build() {
      return new ForgetPwdRsp(retCode, uuid, serviceToken, securityKey, passToken, nickname, headinfo, sex, hasInnerAvatar, hasInnerNickname, hasInnerSex, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_ForgetPwdRsp extends ProtoAdapter<ForgetPwdRsp> {
    public ProtoAdapter_ForgetPwdRsp() {
      super(FieldEncoding.LENGTH_DELIMITED, ForgetPwdRsp.class);
    }

    @Override
    public int encodedSize(ForgetPwdRsp value) {
    ...
    @Override
    public void encode(ProtoWriter writer, ForgetPwdRsp value) throws IOException {
    ...
    @Override
    public ForgetPwdRsp decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public ForgetPwdRsp redact(ForgetPwdRsp value) {
