...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
     ...
     * @param refreshView
     */
    public final void setPullDownToRefreshing(final PullToRefreshBase<T> refreshView) {
        if (!isRefreshing()) {
            mCurrentMode = Mode.PULL_FROM_START;
     ...
     * @param refreshView
     */
    public final void setPullUpToRefreshing(final PullToRefreshBase<T> refreshView) {
        if (!isRefreshing()) {
            mCurrentMode = Mode.PULL_FROM_END;
            setState(State.MANUAL_REFRESHING, true);
        }
