...
public class SendGiftCircleCountDownView extends ProgressBar {
    ...
    private int mRadius = DisplayUtils.dip2px(29.33f);//半径
    ...
    public SendGiftCircleCountDownView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SendGiftCircleCountDownView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader mShader = new SweepGradient(getWidth() / 2, getHeight() / 2,
                new int[]{GlobalData.app().getResources().getColor(R.color.color_ff7700),
                        GlobalData.app().getResources().getColor(R.color.color_ffaa00),
                        GlobalData.app().getResources().getColor(R.color.color_ffaa00),
                        GlobalData.app().getResources().getColor(R.color.color_ff7700)
                }, null);
