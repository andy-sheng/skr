...
public class CircularProgressBar extends View{
    ...
    private float strokeWidth = getResources().getDimension(R.dimen.view_dimen_8);
    private float backgroundStrokeWidth = getResources().getDimension(R.dimen.view_dimen_3);
