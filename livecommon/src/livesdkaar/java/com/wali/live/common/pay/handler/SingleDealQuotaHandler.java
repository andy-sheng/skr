...
import static com.wali.live.common.pay.constant.PayConstant.SINGLE_DEAL_QUOTA_MIWALLET;
import static com.wali.live.common.pay.constant.PayConstant.SINGLE_DEAL_QUOTA_WEIXIN;
...
import static com.wali.live.statistics.StatisticsKey.Recharge.EXCEED_SINGLE_DEAL_QUOTA;
            ...
            case WEIXIN:
                if (item.getPrice() > SINGLE_DEAL_QUOTA_WEIXIN) {
                    ...
                    StatisticsAlmightyWorker.getsInstance().recordDelay(AC_APP, KEY,
                            PayStatisticUtils.getRechargeTemplate(EXCEED_SINGLE_DEAL_QUOTA, getCurrentPayWay()), TIMES, "1");
