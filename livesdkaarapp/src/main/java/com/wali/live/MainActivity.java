        ...
        findViewById(R.id.live_test_tv).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (AccountAuthManager.triggerActionNeedAccount(MainActivity.this)) {
                    MiLiveSdkController.getInstance().openNormalLive(MainActivity.this, null);
                }
            }
        });
    }
            ...
            public void onClick(View v) {
                ...
                Observable.just(0).map(new Func1<Integer, Object>() {
                    ...
                    public Object call(Integer integer) {
                        ...
                        MiLiveSdkController.getInstance().openWatch(MainActivity.this, liveShow.getUid(), liveShow.getLiveId(), liveShow.getUrl(), 0);
                        return null;
                    }
                }).subscribeOn(Schedulers.io())
                        .observeOn(AndroidSchedulers.mainThread())
