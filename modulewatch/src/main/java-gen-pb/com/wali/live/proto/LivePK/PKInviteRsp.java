...
public final class PKInviteRsp extends Message<PKInviteRsp, PKInviteRsp.Builder> {
  ...
  public PKInviteRsp(Integer ret_code) {
    this(ret_code, ByteString.EMPTY);
  }

  public PKInviteRsp(Integer ret_code, ByteString unknownFields) {
  ...
  public static final PKInviteRsp parseFrom(byte[] data) throws IOException {
    PKInviteRsp c = null;
       c = PKInviteRsp.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<PKInviteRsp, Builder> {
    ...
    public PKInviteRsp build() {
      return new PKInviteRsp(ret_code, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_PKInviteRsp extends ProtoAdapter<PKInviteRsp> {
    public ProtoAdapter_PKInviteRsp() {
