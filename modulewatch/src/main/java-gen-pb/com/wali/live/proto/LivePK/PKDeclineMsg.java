...
public final class PKDeclineMsg extends Message<PKDeclineMsg, PKDeclineMsg.Builder> {
  public static final ProtoAdapter<PKDeclineMsg> ADAPTER = new ProtoAdapter_PKDeclineMsg();
  ...
  public PKDeclineMsg(Long uuid, Long pk_uuid, String pk_liveid, Integer type, Long admin_uuid,
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof PKDeclineMsg)) return false;
    PKDeclineMsg o = (PKDeclineMsg) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "PKDeclineMsg{").append('}').toString();
  }

  public byte[] toByteArray() {
    return PKDeclineMsg.ADAPTER.encode(this);
  }

  public static final PKDeclineMsg parseFrom(byte[] data) throws IOException {
    PKDeclineMsg c = null;
       c = PKDeclineMsg.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<PKDeclineMsg, Builder> {
    public Long uuid;
    ...
    @Override
    public PKDeclineMsg build() {
      return new PKDeclineMsg(uuid, pk_uuid, pk_liveid, type, admin_uuid, nickname, admin_nickname, pk_nickname, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_PKDeclineMsg extends ProtoAdapter<PKDeclineMsg> {
    public ProtoAdapter_PKDeclineMsg() {
      super(FieldEncoding.LENGTH_DELIMITED, PKDeclineMsg.class);
    }

    @Override
    public int encodedSize(PKDeclineMsg value) {
    ...
    @Override
    public void encode(ProtoWriter writer, PKDeclineMsg value) throws IOException {
    ...
    @Override
    public PKDeclineMsg decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public PKDeclineMsg redact(PKDeclineMsg value) {
