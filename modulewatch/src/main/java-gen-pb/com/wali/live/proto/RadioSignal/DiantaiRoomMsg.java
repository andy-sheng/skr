...
public final class DiantaiRoomMsg extends Message<DiantaiRoomMsg, DiantaiRoomMsg.Builder> {
  public static final ProtoAdapter<DiantaiRoomMsg> ADAPTER = new ProtoAdapter_DiantaiRoomMsg();
  ...
  public DiantaiRoomMsg(Integer action, Integer diantai_id, String room_id, Long from_zuid,
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof DiantaiRoomMsg)) return false;
    DiantaiRoomMsg o = (DiantaiRoomMsg) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "DiantaiRoomMsg{").append('}').toString();
  }

  public byte[] toByteArray() {
    return DiantaiRoomMsg.ADAPTER.encode(this);
  }

  public static final DiantaiRoomMsg parseFrom(byte[] data) throws IOException {
    DiantaiRoomMsg c = null;
       c = DiantaiRoomMsg.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<DiantaiRoomMsg, Builder> {
    ...
    public DiantaiRoomMsg build() {
      return new DiantaiRoomMsg(action, diantai_id, room_id, from_zuid, to_zuid, members, sync_ts, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_DiantaiRoomMsg extends ProtoAdapter<DiantaiRoomMsg> {
    public ProtoAdapter_DiantaiRoomMsg() {
      super(FieldEncoding.LENGTH_DELIMITED, DiantaiRoomMsg.class);
    }

    @Override
    public int encodedSize(DiantaiRoomMsg value) {
    ...
    @Override
    public void encode(ProtoWriter writer, DiantaiRoomMsg value) throws IOException {
    ...
    @Override
    public DiantaiRoomMsg decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public DiantaiRoomMsg redact(DiantaiRoomMsg value) {
