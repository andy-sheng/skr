 ...
 */
public final class PKCancelInviteReq extends Message<PKCancelInviteReq, PKCancelInviteReq.Builder> {
  public static final ProtoAdapter<PKCancelInviteReq> ADAPTER = new ProtoAdapter_PKCancelInviteReq();
  ...
  public PKCancelInviteReq(Long uuid, String liveid, Long pk_uuid, Integer type, PKSetting setting,
      Long admin_uuid) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof PKCancelInviteReq)) return false;
    PKCancelInviteReq o = (PKCancelInviteReq) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "PKCancelInviteReq{").append('}').toString();
  }

  public byte[] toByteArray() {
    return PKCancelInviteReq.ADAPTER.encode(this);
  }

  public static final class Builder extends Message.Builder<PKCancelInviteReq, Builder> {
    public Long uuid;
    ...
    @Override
    public PKCancelInviteReq build() {
      if (uuid == null
          || liveid == null
          || pk_uuid == null) {
      ...
      return new PKCancelInviteReq(uuid, liveid, pk_uuid, type, setting, admin_uuid, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_PKCancelInviteReq extends ProtoAdapter<PKCancelInviteReq> {
    public ProtoAdapter_PKCancelInviteReq() {
      super(FieldEncoding.LENGTH_DELIMITED, PKCancelInviteReq.class);
    }

    @Override
    public int encodedSize(PKCancelInviteReq value) {
    ...
    @Override
    public void encode(ProtoWriter writer, PKCancelInviteReq value) throws IOException {
    ...
    @Override
    public PKCancelInviteReq decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public PKCancelInviteReq redact(PKCancelInviteReq value) {
