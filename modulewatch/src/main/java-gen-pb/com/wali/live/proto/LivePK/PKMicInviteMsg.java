...
public final class PKMicInviteMsg extends Message<PKMicInviteMsg, PKMicInviteMsg.Builder> {
  public static final ProtoAdapter<PKMicInviteMsg> ADAPTER = new ProtoAdapter_PKMicInviteMsg();
  ...
  public PKMicInviteMsg(Long uuid, String liveid, Long mic_uuid, Integer type, String nickname,
      Long admin_uuid, String admin_nickname, String mic_nickname) {
    this(uuid, liveid, mic_uuid, type, nickname, admin_uuid, admin_nickname, mic_nickname, ByteString.EMPTY);
  }

  public PKMicInviteMsg(Long uuid, String liveid, Long mic_uuid, Integer type, String nickname,
      Long admin_uuid, String admin_nickname, String mic_nickname, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof PKMicInviteMsg)) return false;
    PKMicInviteMsg o = (PKMicInviteMsg) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "PKMicInviteMsg{").append('}').toString();
  }

  public byte[] toByteArray() {
    return PKMicInviteMsg.ADAPTER.encode(this);
  }

  public static final PKMicInviteMsg parseFrom(byte[] data) throws IOException {
    PKMicInviteMsg c = null;
       c = PKMicInviteMsg.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<PKMicInviteMsg, Builder> {
    public Long uuid;
    ...
    @Override
    public PKMicInviteMsg build() {
      return new PKMicInviteMsg(uuid, liveid, mic_uuid, type, nickname, admin_uuid, admin_nickname, mic_nickname, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_PKMicInviteMsg extends ProtoAdapter<PKMicInviteMsg> {
    public ProtoAdapter_PKMicInviteMsg() {
      super(FieldEncoding.LENGTH_DELIMITED, PKMicInviteMsg.class);
    }

    @Override
    public int encodedSize(PKMicInviteMsg value) {
    ...
    @Override
    public void encode(ProtoWriter writer, PKMicInviteMsg value) throws IOException {
    ...
    @Override
    public PKMicInviteMsg decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public PKMicInviteMsg redact(PKMicInviteMsg value) {
