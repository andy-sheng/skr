 ...
 */
public final class MicDeclineReq extends Message<MicDeclineReq, MicDeclineReq.Builder> {
  public static final ProtoAdapter<MicDeclineReq> ADAPTER = new ProtoAdapter_MicDeclineReq();
  ...
  /**
   * 0：未使用 1：场控发起，主播1拒绝 2：场控发起，主播2拒绝
   */
  @WireField(
      tag = 4,
  ...
  public MicDeclineReq(Long admin_uuid, Long mic_uuid, String mic_liveid, Integer type, Long zuid,
      String liveid) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MicDeclineReq)) return false;
    MicDeclineReq o = (MicDeclineReq) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "MicDeclineReq{").append('}').toString();
  }

  public byte[] toByteArray() {
    return MicDeclineReq.ADAPTER.encode(this);
  }

  public static final class Builder extends Message.Builder<MicDeclineReq, Builder> {
    ...
    @Override
    public MicDeclineReq build() {
      if (admin_uuid == null
          || mic_uuid == null) {
        throw Internal.missingRequiredFields(admin_uuid, "admin_uuid",
            mic_uuid, "mic_uuid");
      }
      return new MicDeclineReq(admin_uuid, mic_uuid, mic_liveid, type, zuid, liveid, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_MicDeclineReq extends ProtoAdapter<MicDeclineReq> {
    public ProtoAdapter_MicDeclineReq() {
      super(FieldEncoding.LENGTH_DELIMITED, MicDeclineReq.class);
    }

    @Override
    public int encodedSize(MicDeclineReq value) {
    ...
    @Override
    public void encode(ProtoWriter writer, MicDeclineReq value) throws IOException {
    ...
    @Override
    public MicDeclineReq decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public MicDeclineReq redact(MicDeclineReq value) {
