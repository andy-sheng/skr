 ...
 */
public final class MicCancelInviteReq extends Message<MicCancelInviteReq, MicCancelInviteReq.Builder> {
  public static final ProtoAdapter<MicCancelInviteReq> ADAPTER = new ProtoAdapter_MicCancelInviteReq();
  ...
  /**
   * 0：未使用  1：场控发起，取消邀请主播1  2：场控发起，取消邀请主播2
   */
  @WireField(
      tag = 4,
  ...
  public MicCancelInviteReq(Long admin_uuid, String liveid, Long mic_uuid, Integer type,
      Long zuid) {
    this(admin_uuid, liveid, mic_uuid, type, zuid, ByteString.EMPTY);
  }

  public MicCancelInviteReq(Long admin_uuid, String liveid, Long mic_uuid, Integer type, Long zuid,
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MicCancelInviteReq)) return false;
    MicCancelInviteReq o = (MicCancelInviteReq) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "MicCancelInviteReq{").append('}').toString();
  }

  public byte[] toByteArray() {
    return MicCancelInviteReq.ADAPTER.encode(this);
  }

  public static final class Builder extends Message.Builder<MicCancelInviteReq, Builder> {
    ...
    @Override
    public MicCancelInviteReq build() {
      if (admin_uuid == null
          || liveid == null
          || mic_uuid == null) {
      ...
      return new MicCancelInviteReq(admin_uuid, liveid, mic_uuid, type, zuid, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_MicCancelInviteReq extends ProtoAdapter<MicCancelInviteReq> {
    public ProtoAdapter_MicCancelInviteReq() {
      super(FieldEncoding.LENGTH_DELIMITED, MicCancelInviteReq.class);
    }

    @Override
    public int encodedSize(MicCancelInviteReq value) {
    ...
    @Override
    public void encode(ProtoWriter writer, MicCancelInviteReq value) throws IOException {
    ...
    @Override
    public MicCancelInviteReq decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public MicCancelInviteReq redact(MicCancelInviteReq value) {
