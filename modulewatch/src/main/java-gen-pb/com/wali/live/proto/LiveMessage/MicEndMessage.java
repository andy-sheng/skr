 ...
 * mic结束消息
 */
public final class MicEndMessage extends Message<MicEndMessage, MicEndMessage.Builder> {
  public static final ProtoAdapter<MicEndMessage> ADAPTER = new ProtoAdapter_MicEndMessage();
  ...
  @WireField(
      tag = 3,
      adapter = "com.wali.live.proto.LiveCommon.MicInfo#ADAPTER",
      label = WireField.Label.REQUIRED
  )
  ...
  public MicEndMessage(Long zuid, String liveId, MicInfo micInfo, Boolean enableViewerMic,
      Integer type) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MicEndMessage)) return false;
    MicEndMessage o = (MicEndMessage) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "MicEndMessage{").append('}').toString();
  }

  public byte[] toByteArray() {
    return MicEndMessage.ADAPTER.encode(this);
  }

  public static final MicEndMessage parseFrom(byte[] data) throws IOException {
    MicEndMessage c = null;
       c = MicEndMessage.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<MicEndMessage, Builder> {
    public Long zuid;
    ...
    public MicEndMessage build() {
      return new MicEndMessage(zuid, liveId, micInfo, enableViewerMic, type, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_MicEndMessage extends ProtoAdapter<MicEndMessage> {
    public ProtoAdapter_MicEndMessage() {
      super(FieldEncoding.LENGTH_DELIMITED, MicEndMessage.class);
    }

    @Override
    public int encodedSize(MicEndMessage value) {
    ...
    @Override
    public void encode(ProtoWriter writer, MicEndMessage value) throws IOException {
    ...
    @Override
    public MicEndMessage decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public MicEndMessage redact(MicEndMessage value) {
