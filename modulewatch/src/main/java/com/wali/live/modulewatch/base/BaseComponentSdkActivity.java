...
import com.wali.live.modulewatch.active.KeepActiveProcessor;
...
import com.wali.live.modulewatch.base.assist.IPushMsgProcessor;
import com.wali.live.modulewatch.base.event.WatchOrReplayActivityCreated;
 ...
 * @module 基础模块
 */
public abstract class BaseComponentSdkActivity extends BaseActivity {
...
//    protected GiftRoomEffectView mGiftRoomEffectView;
    ...
    protected void onPause() {
        super.onPause();
        mMyRoomData.setIsForeground(false);
    }
    ...
    protected void onResume() {
        super.onResume();
        mMyRoomData.setIsForeground(true);
    }
