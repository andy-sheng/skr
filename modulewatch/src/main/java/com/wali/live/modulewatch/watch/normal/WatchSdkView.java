...
import com.wali.live.modulewatch.barrage.presenter.LiveCommentPresenter;
...
//            mController.postEvent(BaseSdkController.MSG_FORCE_ROTATE_SCREEN);
//        }
    }
...
//        }
    ...
    public void startView() {
        ...
        registerAction(BaseSdkController.MSG_BACKGROUND_CLICK);
        registerAction(BaseSdkController.MSG_SHOW_FOLLOW_GUIDE);
        registerAction(BaseSdkController.MSG_FOLLOW_COUNT_DOWN);
        registerAction(BaseSdkController.MSG_SHOW_SEND_ENVELOPE);
        registerAction(BaseSdkController.MSG_VIDEO_PORTRAIT);
        registerAction(BaseSdkController.MSG_VIDEO_LANDSCAPE);
        registerAction(BaseSdkController.MSG_POP_INSUFFICIENT_TIPS);
        registerAction(BaseSdkController.MSG_SHOW_FEEDBACK_VIEW);
        registerAction(BaseSdkController.MSG_SHOW_BIG_TURN_TABLE_BTN);
        registerAction(BaseSdkController.MSG_SHOW_BIG_TURN_TABLE_PANEL);
        registerAction(BaseSdkController.MSG_SHOW_BIG_TURN_TABLE_TIPS);
        registerAction(BaseSdkController.MSG_ON_BACK_PRESSED);
...
//                if (mIsGameMode) {
//                    mController.postEvent(BaseSdkController.MSG_ENABLE_MOVE_VIEW);
...
//                    mController.postEvent(BaseSdkController.MSG_HIDE_GAME_INPUT);
//                }
...
//                mTopAreaView.setVisibility(View.VISIBLE);
                return true;
            case BaseSdkController.MSG_BACKGROUND_CLICK:
//                if (mController.postEvent(BaseSdkController.MSG_HIDE_INPUT_VIEW)) {
//                    return true;
//                }
//                if (mIsGameMode && mIsLandscape) {
...
//                }
                break;
            case BaseSdkController.MSG_FOLLOW_COUNT_DOWN:
...
//                }
                break;
            case BaseSdkController.MSG_SHOW_FOLLOW_GUIDE: {
//                if (mController.mMyRoomData.isEnableRelationChain()) {
...
//                }
            ...
            break;
            case BaseSdkController.MSG_SHOW_SEND_ENVELOPE:
//                SendEnvelopeFragment.openFragment((BaseActivity) mActivity, mController.mMyRoomData);
                return true;
            case BaseSdkController.MSG_VIDEO_LANDSCAPE:
//                mController.mMyRoomData.setVideoLandscape(true);
//                updateRotateBtn();
                break;
            case BaseSdkController.MSG_VIDEO_PORTRAIT:
//                mController.mMyRoomData.setVideoLandscape(false);
//                updateRotateBtn();
                break;
            case BaseSdkController.MSG_POP_INSUFFICIENT_TIPS:
//                popInsufficientTips();
                break;
            case BaseSdkController.MSG_SHOW_FEEDBACK_VIEW:
//                showFeedBackDialog();
                break;
            case BaseSdkController.MSG_SHOW_BIG_TURN_TABLE_BTN:
...
//                }
                break;
            case BaseSdkController.MSG_SHOW_BIG_TURN_TABLE_PANEL:
...
//                }
                break;
            case BaseSdkController.MSG_SHOW_BIG_TURN_TABLE_TIPS:
//                showBigTurnTableTips((Integer) params.getItem(0), (Integer) params.getItem(1));
                break;
            case BaseSdkController.MSG_ON_BACK_PRESSED:
//                if (mWatchBigTurnTablePanelPresenter != null
