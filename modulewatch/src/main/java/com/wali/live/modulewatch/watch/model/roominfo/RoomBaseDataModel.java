...
import com.wali.live.modulewatch.watch.model.game.GameInfoModel;
...
public class RoomBaseDataModel implements Serializable {
    ...
    private AnchorModel mOwner = new AnchorModel();
     ...
     * 拉取消息类型
     */
    private int getMessageMode = 0;  //RoomMessagePresenter.PUSH_MODE;
    ...
    public void setHuyaInfo(ThirdPartyInfo huyaInfo) {
    ...
    public void setEnableRelationChain(boolean enableFollow) {
        mEnableRelationChain = enableFollow;
    }
