...
public class BlurUtils {
     ...
     * @return
     */
    public Bitmap convertToBlur(Bitmap bmp) {
        // 高斯矩阵
        int[] gauss = new int[]{
                1, 2, 1, 2, 4, 2, 1, 2, 1
        };
    ...
    public void blurFractional(int[] in, int[] out, int width,
...
//    内置高斯模糊效果,
//    public static void blurByRender(Bitmap input, float radius, Bitmap output) {
//        // 使用Renderscript,虽然多了一步565转8888,但是速度还是更快
//        RenderScript rs = RenderScript.create(U.app());
