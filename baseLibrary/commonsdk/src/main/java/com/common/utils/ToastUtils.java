...
public class ToastUtils {
    ...
    private void show(final int resId, final int duration) {
        try {
    ...
    private void show(final int resId, final int duration, final Object... args) {
        try {
            CharSequence text = U.app().getResources().getText(resId);
    ...
    private void show(final CharSequence text, final int duration) {
        U.getCommonUtils().getUiHandler().post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = ToastFactory.makeToast(U.app(), text, duration);
    ...
    private void show(final View view, final int duration) {
        U.getCommonUtils().getUiHandler().post(new Runnable() {
            ...
            public void run() {
                cancel();
                sToast = ToastFactory.newToast(U.app());
                sToast.setView(view);
