...
public final class ReflectUtils {
    ...
    public <T> T invokeConstructor(Class<T> cls, Class[] parameterTypes, Object... args) throws
    ...
    public Object readStaticField(Class<?> c, String fieldName) throws NoSuchFieldException, IllegalAccessException {
        return readField(c, null, fieldName);
    }

    public Object readField(Object target, String fieldName) throws IllegalAccessException, NoSuchFieldException {
        return readField(target.getClass(), target, fieldName);
    }

    public Object readField(Class<?> c, Object target, String fieldName) throws IllegalAccessException, NoSuchFieldException {
        Field f = getField(c, fieldName);

        return readField(f, target);
    }

    public Object readField(final Field field, final Object target) throws IllegalAccessException {
        return field.get(target);
    }

    public void writeField(Object target, String fName, Object value) throws NoSuchFieldException, IllegalAccessException {
        writeField(target.getClass(), target, fName, value);
    }

    public void writeField(Class<?> c, Object object, String fName, Object value) throws NoSuchFieldException, IllegalAccessException {
        Field f = getField(c, fName);
        writeField(f, object, value);
    }

    public void writeField(final Field field, final Object target, final Object value) throws IllegalAccessException {
    ...
    public void removeFieldFinalModifier(final Field field) {
    ...
    public Object invokeMethod(final Object object, final String methodName, Class<?>[] methodParamTypes, Object... args)
    ...
    public Object invokeMethod(ClassLoader loader, String clzName,
    ...
    public void setAccessible(AccessibleObject ao, boolean value) {
    ...
    public final void dumpObject(Object object, FileDescriptor fd, PrintWriter writer, String[] args) {
        try {
