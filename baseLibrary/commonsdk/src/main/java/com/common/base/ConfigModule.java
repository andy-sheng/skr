...
public interface ConfigModule {
    /**
     * 使用{@link GlobalParams.Builder}给框架配置一些配置参数
     *
     * @param builder
     */
    void applyOptions(GlobalParams.Builder builder);
     ...
     * @param lifecycles
     */
    void injectAppLifecycle(List<AppLifecycles> lifecycles);
     ...
     * @param lifecycles
     */
    void injectFragmentLifecycle(List<FragmentManager.FragmentLifecycleCallbacks> lifecycles);
}
