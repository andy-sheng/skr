...
public class SrcSlecterDrawableCreater implements ICreateDrawable {
    ...
    public Drawable create() throws Exception {
        ...
        for (int i = 0; i < selectorTa.getIndexCount(); i++) {
            ...
            if (attr == R.styleable.ImageView_src_checkable_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, android.R.attr.state_checkable);
            } else if (attr == R.styleable.ImageView_src_unCheckable_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, -android.R.attr.state_checkable);
            } else if (attr == R.styleable.ImageView_src_checked_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, android.R.attr.state_checked);
            } else if (attr == R.styleable.ImageView_src_unChecked_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, -android.R.attr.state_checked);
            } else if (attr == R.styleable.ImageView_src_enabled_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, android.R.attr.state_enabled);
            } else if (attr == R.styleable.ImageView_src_unEnabled_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, -android.R.attr.state_enabled);
            } else if (attr == R.styleable.ImageView_src_selected_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, android.R.attr.state_selected);
            } else if (attr == R.styleable.ImageView_src_unSelected_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, -android.R.attr.state_selected);
            } else if (attr == R.styleable.ImageView_src_pressed_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, android.R.attr.state_pressed);
            } else if (attr == R.styleable.ImageView_src_unPressed_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, -android.R.attr.state_pressed);
            } else if (attr == R.styleable.ImageView_src_focused_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, android.R.attr.state_focused);
            } else if (attr == R.styleable.ImageView_src_unFocused_drawable) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, -android.R.attr.state_focused);
            } else if (attr == R.styleable.ImageView_src_focused_hovered) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, android.R.attr.state_hovered);
            } else if (attr == R.styleable.ImageView_src_unFocused_hovered) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, -android.R.attr.state_hovered);
            } else if (attr == R.styleable.ImageView_src_focused_activated) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, android.R.attr.state_activated);
            } else if (attr == R.styleable.ImageView_src_unFocused_activated) {
                setSelectorDrawable(selectorTa, stateListDrawable, attr, -android.R.attr.state_activated);
            }
        }
