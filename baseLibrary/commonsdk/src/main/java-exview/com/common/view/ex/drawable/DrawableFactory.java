...
public class DrawableFactory {
    ...
    //适配早期版本的属性
    public static StateListDrawable getPressDrawable(GradientDrawable drawable, TypedArray typedArray)
            throws Exception {
        return (StateListDrawable) new PressDrawableCreator(drawable, typedArray).create();
    }

    public static Drawable getSelectorDrawable(TypedArray bgArray) throws Exception {
        // 优先弄selector
        Drawable drawable = new SelectorDrawableCreator(bgArray).create();
        return drawable;
    }
}
