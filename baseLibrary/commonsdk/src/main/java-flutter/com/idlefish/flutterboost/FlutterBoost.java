...
public class FlutterBoost {
    ...
    public final static String TAG = "FlutterBoost";
    ...
    public void doInitialFlutter() {
        MyLog.d(TAG,"doInitialFlutter mEngine="+mEngine );
        ...
        if (flutterEngine.getDartExecutor().isExecutingDart()) {
            MyLog.d(TAG,"doInitialFlutter getDartExecutor isExecutingDart=true");
            return;
        }
    ...
    public void boostPluginRegistry(){
        if(mRegistry!=null){
            if(mRegistry.hasPlugin("boostPluginRegistry")){
                MyLog.d(TAG,"boostPluginRegistry .hasPlugin boostPluginRegistry" );
            }else{
                MyLog.d(TAG,"boostPluginRegistry register" );
                mPlatform.registerPlugins(mRegistry);
                mRegistry.registrarFor("boostPluginRegistry");
            }
        }else{
            MyLog.d(TAG,"boostPluginRegistry mRegistry==null" );
