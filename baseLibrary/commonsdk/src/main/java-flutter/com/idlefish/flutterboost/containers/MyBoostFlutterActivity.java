...
public class MyBoostFlutterActivity extends BaseActivity
    ...
    public static NewEngineIntentBuilder withNewEngine() {
        return new NewEngineIntentBuilder(MyBoostFlutterActivity.class);
    }


    public static class NewEngineIntentBuilder {
        private final Class<? extends MyBoostFlutterActivity> activityClass;
        private String backgroundMode = DEFAULT_BACKGROUND_MODE;
        private String url = "";
        private Map params = new HashMap();


        protected NewEngineIntentBuilder(@NonNull Class<? extends MyBoostFlutterActivity> activityClass) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        RelativeLayout rootView = (RelativeLayout) View.inflate(this, R.layout.empty_activity_layout,null);
    ...
    @Override
    public int initView(@org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        return -1;
    }
