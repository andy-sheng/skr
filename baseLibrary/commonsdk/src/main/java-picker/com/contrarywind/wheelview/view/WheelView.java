package com.contrarywind.wheelview.view;
...
import com.contrarywind.wheelview.adapter.WheelAdapter;
import com.contrarywind.wheelview.interfaces.IPickerViewData;
import com.contrarywind.wheelview.listener.LoopViewGestureListener;
import com.contrarywind.wheelview.listener.OnItemSelectedListener;
import com.contrarywind.wheelview.timer.InertiaTimerTask;
import com.contrarywind.wheelview.timer.MessageHandler;
import com.contrarywind.wheelview.timer.SmoothScrollTimerTask;
 ...
 * 3d滚轮控件
 *
 * 具体用法见 https://github.com/Bigkoo/Android-PickerView
 */
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.textsize_25_dp);//默认大小
        ...
        if (attrs != null) {
            ...
            textColorCenter = a.getColor(R.styleable.WheelView_wheelview_textColorCenter, 0xFF0C2275);
...
//                canvas.scale(1.0F, (float) Math.sin(radian));
                if (translateY <= firstLineY && maxTextHeight + translateY >= firstLineY) {
                    ...
                    // 控制透明度
                    paintOuterText.setAlpha((int) (((1 - offsetCoefficient) * 255) * 0.2));
                    // 控制文字水平偏移距离
