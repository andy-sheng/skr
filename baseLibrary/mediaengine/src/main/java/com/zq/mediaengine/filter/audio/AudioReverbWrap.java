...
public class AudioReverbWrap {
    ...
    public void config(int sampleRate, int channels) {
        config(mReverbInstance, sampleRate, channels);
    }
    ...
    private native void config(long reverbInstance, int sampleRate, int channels);
