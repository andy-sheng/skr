...
ST_CIPHERCONTENT stCipherContents[] = {
    ...
    {BEAUTY_SAHKE_COLOR,FRAGMENT_SHADER_SHAKE_COLOR_KEY,FRAGMENT_SHADER_SHAKE_COLOR},
    {BEAUTY_SHAKE_ZOOM,FRAGMENT_SHADER_SHAKE_ZOOM_KEY,FRAGMENT_SHADER_SHAKE_ZOOM},
    {BEAUTY_SHAKE_WAVE,FRAGMENT_SHADER_SHAKE_SHOCK_WAVE_KEY,FRAGMENT_SHADER_SHAKE_SHOCK_WAVE},
    {BEAUTY_SHAKE_70S,FRAGMENT_SHADER_SHAKE_70S_KEY,FRAGMENT_SHADER_SHAKE_70S},
    {BEAUTY_SHAKE_XSINGLE,FRAGMENT_SHADER_SHAKE_XSINGLE_KEY,FRAGMENT_SHADER_SHAKE_XSINGLE},
    {BEAUTY_SHAKE_ILLUSION,FRAGMENT_SHADER_SHAKE_ILLUSION_KEY,FRAGMENT_SHADER_SHAKE_ILLUSION},
 };
