...
public class PluginProviderClient2 {
     ...
     * 调用插件里的Provider
     *
     * @see ContentProviderClient#query(Uri, String[], String, String[], String)
     */
     ...
     * 调用插件里的Provider
     *
     * @see ContentProviderClient#query(Uri, String[], String, String[], String, CancellationSignal)
     */
    @TargetApi(16)
     ...
     * 调用插件里的Provider
     *
     * @see ContentProviderClient#update(Uri, ContentValues, String, String[])
     */
