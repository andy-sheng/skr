        ...
        while (!ss.eof())
        {
            ...
            case MTT_ARBEAT:
                for (int i = 0; i < lines; i++)
                {
                    ...
                    bt.accFrameLenPerSection = round( (60.0 / bt.bpmfloat) * 1.0 * bt.beatNumPerSection * m_sampleRate);
                    ...
                    bt.vocalFrameLenPerSection = round( (60.0 / bt.bpmfloat) * 1.0 * bt.beatNumPerSection * m_vocalSampleRate);
