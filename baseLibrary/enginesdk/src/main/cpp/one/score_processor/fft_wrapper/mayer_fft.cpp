...
void MayerFft::mayer_fht(REAL *fz, int n)
{
    /*  REAL a,b;
...
void MayerFft::mayer_fft(int n, REAL *real, REAL *imag)
{
    REAL a, b, c, d;
    REAL q, r, s, t;
    int i, j, k;
...
void MayerFft::mayer_ifft(int n, REAL *real, REAL *imag)
{
    REAL a, b, c, d;
    REAL q, r, s, t;
    int i, j, k;
...
void MayerFft::mayer_realfft(int n, REAL *real)
{
    REAL a, b;
    int i, j, k;
...
void MayerFft::mayer_realifft(int n, REAL *real)
{
    REAL a, b;
    int i, j, k;
