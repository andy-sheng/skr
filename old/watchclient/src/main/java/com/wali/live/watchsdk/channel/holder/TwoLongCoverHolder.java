...
public class TwoLongCoverHolder extends RepeatHolder {
    ...
    protected void bindVideoItem(ChannelLiveViewModel.VideoItem item, int index) {
        ...
        mNameTvs[index].setText(item.getUser().getNickname());
    ...
    protected int getImageWidth() {
        return (DisplayUtils.getScreenWidth() - DisplayUtils.dip2px(10)) / 2;
    }

    @Override
    protected int getImageHeight() {
        int width = (DisplayUtils.getScreenWidth() - DisplayUtils.dip2px(10)) / 2;
        return width * 4 / 3;
    }
