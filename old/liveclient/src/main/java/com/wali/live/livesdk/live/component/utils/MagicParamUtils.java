...
public class MagicParamUtils {
    ...
    public static void saveBeautyLevel(int level) {
        PreferenceUtils.setSettingInt(PreferenceUtils.PREF_KEY_FACE_BEAUTY_LEVEL, level);
    }

    public static int getBeautyLevel() {
        return PreferenceUtils.getSettingInt(PreferenceUtils.PREF_KEY_FACE_BEAUTY_LEVEL, GalileoConstants.BEAUTY_LEVEL_HIGH);
    }

    public static void saveFilterIntensity(int intensity) {
        PreferenceUtils.setSettingInt(PreferenceUtils.PREF_KEY_FILTER_INTENSITY, intensity);
    }

    public static int getFilterIntensity() {
        return PreferenceUtils.getSettingInt(PreferenceUtils.PREF_KEY_FILTER_INTENSITY, 100);
    }
}
