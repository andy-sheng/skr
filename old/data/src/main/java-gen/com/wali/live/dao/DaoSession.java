...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase db, IdentityScopeType type, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig>
        ...
        sixinMessageDaoConfig = daoConfigMap.get(SixinMessageDao.class).clone();
        sixinMessageDaoConfig.initIdentityScope(type);

        groupNotifyDaoConfig = daoConfigMap.get(GroupNotifyDao.class).clone();
        groupNotifyDaoConfig.initIdentityScope(type);
        ...
        sixinMessageDao = new SixinMessageDao(sixinMessageDaoConfig, this);
        groupNotifyDao = new GroupNotifyDao(groupNotifyDaoConfig, this);
        ...
        registerDao(SixinMessage.class, sixinMessageDao);
        registerDao(GroupNotify.class, groupNotifyDao);
    }
    ...
    public void clear() {
        ...
        sixinMessageDaoConfig.getIdentityScope().clear();
        groupNotifyDaoConfig.getIdentityScope().clear();
    }
    ...
    public SixinMessageDao getSixinMessageDao() {
        return sixinMessageDao;
    }

    public GroupNotifyDao getGroupNotifyDao() {
        return groupNotifyDao;
    }
