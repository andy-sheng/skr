...
*/
public class OwnUserInfoDao extends AbstractDao<OwnUserInfo, Void> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(OwnUserInfo entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(OwnUserInfo entity) {
        return null;
    }
