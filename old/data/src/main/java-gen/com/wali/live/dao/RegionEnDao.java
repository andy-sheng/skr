...
/** 
 * DAO for table REGION_EN.
*/
public class RegionEnDao extends AbstractDao<RegionEn, Void> {

    public static final String TABLENAME = "REGION_EN";

    /**
     * Properties of entity RegionEn.<br/>
    ...
    */
    ...
    public RegionEnDao(DaoConfig config) {
        super(config);
    }
    
    public RegionEnDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'REGION_EN' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'REGION_EN'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, RegionEn entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public RegionEn readEntity(Cursor cursor, int offset) {
        RegionEn entity = new RegionEn( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, RegionEn entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(RegionEn entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(RegionEn entity) {
        return null;
    }
