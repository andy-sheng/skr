...
public class MyProgressDialog extends MyAlertDialog {
    ...
    /**
     * Creates a MyProgressDialog with a circular, spinning progress
    ...
    protected void onCreate(Bundle savedInstanceState) {
        // 在MyAlertDialog的基础上，设置其自定义view为progress
        LayoutInflater inflater = LayoutInflater.from(getContext());
        MyLog.d("mProgressStyle:" + mProgressStyle);
        // 进度条
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            // 小菊花
            View view = inflater.inflate(
                    R.layout.my_progress_dialog, null);
            mProgress = (ProgressBar) view.findViewById(R.id.progress);
            mMessageView = (TextView) view.findViewById(R.id.message);
            setView(view);
        }
//        a.recycle();
    ...
    public void setMessage(CharSequence message) {
        if (mProgress != null) {
            MyLog.d("setMessage process!=null");
