...
import static com.wali.live.pay.constant.PayConstant.SINGLE_DEAL_QUOTA_MIWALLET;
import static com.wali.live.pay.constant.PayConstant.SINGLE_DEAL_QUOTA_WEIXIN;
            ...
            case WEIXIN:
                if (item.getPrice() > SINGLE_DEAL_QUOTA_WEIXIN) {
                    ...
                    StatisticsAlmightyWorker.getsInstance().recordDelay(AC_APP, KEY,
                            getRechargeTemplate(EXCEED_SINGLE_DEAL_QUOTA, RechargePresenter.getCurPayWay()), TIMES, "1");
