...
import static com.base.player.engine.IPlayer.MEDIA_INFO_BUFFERING_END;
import static com.base.player.engine.IPlayer.MEDIA_INFO_BUFFERING_START;
...
public class PullStreamerPresenter extends BaseStreamerPresenter<PullStreamerPresenter.ReconnectHelper,
    ...
    public void shiftUp(float ratio) {
        shiftUp(ratio, 0.5f, 0.76f, 1.33f, 1.81f);
    }
