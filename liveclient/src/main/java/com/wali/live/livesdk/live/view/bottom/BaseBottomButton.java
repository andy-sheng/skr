 ...
 * @module 底部面板
 */
public abstract class BaseBottomButton<LISTENER> implements View.OnClickListener {
    ...
    protected @NonNull LISTENER mStatusListener;

    protected abstract String getTAG();

    public final void setStatusListener(LISTENER listener) {
