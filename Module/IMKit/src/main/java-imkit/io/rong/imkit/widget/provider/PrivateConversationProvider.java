...
public class PrivateConversationProvider implements ConversationProvider<UIConversation> {
    ...
    public View newView(Context context, ViewGroup viewGroup) {
        ...
        io.rong.imkit.widget.provider.PrivateConversationProvider.ViewHolder holder = new io.rong.imkit.widget.provider.PrivateConversationProvider.ViewHolder();
    ...
    private void handleMentionedContent(final io.rong.imkit.widget.provider.PrivateConversationProvider.ViewHolder holder, final View view, final UIConversation data) {
    ...
    private void handleDraftContent(final io.rong.imkit.widget.provider.PrivateConversationProvider.ViewHolder holder, final View view, final UIConversation data) {
        final SpannableStringBuilder builder = new SpannableStringBuilder();
    ...
    private void handleCommonContent(final io.rong.imkit.widget.provider.PrivateConversationProvider.ViewHolder holder, final UIConversation data) {
            ...
            holder.content.post(new Runnable() {
                public void run() {
                    if (holder.content.getWidth() > 60 && cutStr != null) {
                        CharSequence str = TextUtils.ellipsize(data.getConversationContent(), holder.content.getPaint(), (float) (holder.content.getWidth() - 60), TruncateAt.END);
    ...
    public void bindView(View view, int position, UIConversation data) {
        io.rong.imkit.widget.provider.PrivateConversationProvider.ViewHolder holder = (io.rong.imkit.widget.provider.PrivateConversationProvider.ViewHolder) view.getTag();
        ...
        if (data == null) {
            ...
            if (TextUtils.isEmpty(data.getDraft()) && !data.getMentionedFlag()) {
                ...
                if (readRec) {
                    if (data.getSentStatus() == SentStatus.READ && data.getConversationSenderId().equals(RongIM.getInstance().getCurrentUserId())) {
