 ...
 */
@MessageTag(value = "SKR:RaceRoomMsgHigh", flag = MessageTag.NONE)
public class RaceRoomHighMsg extends MessageContent {
    public final String TAG = "CustomChatRoomMsg";

    int messageType;
    String contentJsonStr;

    public RaceRoomHighMsg() {

    }

    public RaceRoomHighMsg(byte[] data) {
        String jsonStr = null;
    ...
    public RaceRoomHighMsg(Parcel source) {
     ...
     */
    public static final Creator<RaceRoomHighMsg> CREATOR = new Creator<RaceRoomHighMsg>() {

        @Override
        public RaceRoomHighMsg createFromParcel(Parcel source) {
            return new RaceRoomHighMsg(source);
        }

        @Override
        public RaceRoomHighMsg[] newArray(int size) {
            return new RaceRoomHighMsg[size];
        }
    };
}
