 ...
 */
@MessageTag(value = "SKR:BattleRoomMsgHigh", flag = MessageTag.NONE)
public class BattleRoomHighMsg extends MessageContent {
    public final String TAG = "BattleRoomHighMsg";

    int messageType;
    String contentJsonStr;

    public BattleRoomHighMsg() {

    }

    public BattleRoomHighMsg(byte[] data) {
        String jsonStr = null;
    ...
    public BattleRoomHighMsg(Parcel source) {
     ...
     */
    public static final Creator<BattleRoomHighMsg> CREATOR = new Creator<BattleRoomHighMsg>() {

        @Override
        public BattleRoomHighMsg createFromParcel(Parcel source) {
            return new BattleRoomHighMsg(source);
        }

        @Override
        public BattleRoomHighMsg[] newArray(int size) {
            return new BattleRoomHighMsg[size];
        }
    };
}
