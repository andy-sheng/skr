 ...
 */
@MessageTag(value = "SKR:CustomMsgLow", flag = MessageTag.NONE)
public class CustomChatRoomLowLevelMsg extends MessageContent {
    public final String TAG = "CustomChatRoomMsg";

    int messageType;
    String contentJsonStr;

    public CustomChatRoomLowLevelMsg() {

    }

    public CustomChatRoomLowLevelMsg(byte[] data) {
        String jsonStr = null;
    ...
    public CustomChatRoomLowLevelMsg(Parcel source) {
     ...
     */
    public static final Creator<CustomChatRoomLowLevelMsg> CREATOR = new Creator<CustomChatRoomLowLevelMsg>() {

        @Override
        public CustomChatRoomLowLevelMsg createFromParcel(Parcel source) {
            return new CustomChatRoomLowLevelMsg(source);
        }

        @Override
        public CustomChatRoomLowLevelMsg[] newArray(int size) {
            return new CustomChatRoomLowLevelMsg[size];
        }
    };
}
