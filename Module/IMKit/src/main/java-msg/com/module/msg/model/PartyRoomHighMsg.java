 ...
 */
@MessageTag(value = "SKR:PartyRoomMsgHigh", flag = MessageTag.NONE)
public class PartyRoomHighMsg extends MessageContent {
    public final String TAG = "CustomChatRoomMsg";

    int messageType;
    String contentJsonStr;

    public PartyRoomHighMsg() {

    }

    public PartyRoomHighMsg(byte[] data) {
        String jsonStr = null;
    ...
    public PartyRoomHighMsg(Parcel source) {
     ...
     */
    public static final Creator<PartyRoomHighMsg> CREATOR = new Creator<PartyRoomHighMsg>() {

        @Override
        public PartyRoomHighMsg createFromParcel(Parcel source) {
            return new PartyRoomHighMsg(source);
        }

        @Override
        public PartyRoomHighMsg[] newArray(int size) {
            return new PartyRoomHighMsg[size];
        }
    };
}
