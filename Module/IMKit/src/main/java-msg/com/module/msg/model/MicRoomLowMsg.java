 ...
 */
@MessageTag(value = "SKR:MicRoomMsgLow", flag = MessageTag.NONE)
public class MicRoomLowMsg extends MessageContent {
    public final String TAG = "MicRoomLowMsg";

    int messageType;
    String contentJsonStr;

    public MicRoomLowMsg() {

    }

    public MicRoomLowMsg(byte[] data) {
        String jsonStr = null;
    ...
    public MicRoomLowMsg(Parcel source) {
     ...
     */
    public static final Creator<MicRoomLowMsg> CREATOR = new Creator<MicRoomLowMsg>() {

        @Override
        public MicRoomLowMsg createFromParcel(Parcel source) {
            return new MicRoomLowMsg(source);
        }

        @Override
        public MicRoomLowMsg[] newArray(int size) {
            return new MicRoomLowMsg[size];
        }
    };
}
