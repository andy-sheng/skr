 ...
 */
@MessageTag(value = "SKR:RaceRoomMsgLow", flag = MessageTag.NONE)
public class RaceRoomLowMsg extends MessageContent {
    public final String TAG = "CustomChatRoomMsg";

    int messageType;
    String contentJsonStr;

    public RaceRoomLowMsg() {

    }

    public RaceRoomLowMsg(byte[] data) {
        String jsonStr = null;
    ...
    public RaceRoomLowMsg(Parcel source) {
     ...
     */
    public static final Creator<RaceRoomLowMsg> CREATOR = new Creator<RaceRoomLowMsg>() {

        @Override
        public RaceRoomLowMsg createFromParcel(Parcel source) {
            return new RaceRoomLowMsg(source);
        }

        @Override
        public RaceRoomLowMsg[] newArray(int size) {
            return new RaceRoomLowMsg[size];
        }
    };
}
