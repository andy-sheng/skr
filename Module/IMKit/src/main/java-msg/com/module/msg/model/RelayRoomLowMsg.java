 ...
 */
@MessageTag(value = "SKR:RelayRoomMsgLow", flag = MessageTag.NONE)
public class RelayRoomLowMsg extends MessageContent {
    public final String TAG = "CustomChatRoomMsg";

    int messageType;
    String contentJsonStr;

    public RelayRoomLowMsg() {

    }

    public RelayRoomLowMsg(byte[] data) {
        String jsonStr = null;
    ...
    public RelayRoomLowMsg(Parcel source) {
     ...
     */
    public static final Creator<RelayRoomLowMsg> CREATOR = new Creator<RelayRoomLowMsg>() {

        @Override
        public RelayRoomLowMsg createFromParcel(Parcel source) {
            return new RelayRoomLowMsg(source);
        }

        @Override
        public RelayRoomLowMsg[] newArray(int size) {
            return new RelayRoomLowMsg[size];
        }
    };
}
