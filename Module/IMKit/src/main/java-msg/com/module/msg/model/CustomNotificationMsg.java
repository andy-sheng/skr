...
public class CustomNotificationMsg extends MessageContent {
    ...
    public CustomNotificationMsg() {

    }

    public CustomNotificationMsg(byte[] data) {
        String jsonStr = null;
    ...
    public CustomNotificationMsg(Parcel source) {
     ...
     */
    public static final Creator<CustomNotificationMsg> CREATOR = new Creator<CustomNotificationMsg>() {

        @Override
        public CustomNotificationMsg createFromParcel(Parcel source) {
            return new CustomNotificationMsg(source);
        }

        @Override
        public CustomNotificationMsg[] newArray(int size) {
            return new CustomNotificationMsg[size];
        }
    };
}
