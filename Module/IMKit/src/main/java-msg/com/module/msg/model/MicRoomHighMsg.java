 ...
 */
@MessageTag(value = "SKR:MicRoomMsgHigh", flag = MessageTag.NONE)
public class MicRoomHighMsg extends MessageContent {
    public final String TAG = "MicRoomHighMsg";

    int messageType;
    String contentJsonStr;

    public MicRoomHighMsg() {

    }

    public MicRoomHighMsg(byte[] data) {
        String jsonStr = null;
    ...
    public MicRoomHighMsg(Parcel source) {
     ...
     */
    public static final Creator<MicRoomHighMsg> CREATOR = new Creator<MicRoomHighMsg>() {

        @Override
        public MicRoomHighMsg createFromParcel(Parcel source) {
            return new MicRoomHighMsg(source);
        }

        @Override
        public MicRoomHighMsg[] newArray(int size) {
            return new MicRoomHighMsg[size];
        }
    };
}
