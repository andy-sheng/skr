 ...
 */
@MessageTag(value = "SKR:RelayRoomMsgHigh", flag = MessageTag.NONE)
public class RelayRoomHighMsg extends MessageContent {
    public final String TAG = "CustomChatRoomMsg";

    int messageType;
    String contentJsonStr;

    public RelayRoomHighMsg() {

    }

    public RelayRoomHighMsg(byte[] data) {
        String jsonStr = null;
    ...
    public RelayRoomHighMsg(Parcel source) {
     ...
     */
    public static final Creator<RelayRoomHighMsg> CREATOR = new Creator<RelayRoomHighMsg>() {

        @Override
        public RelayRoomHighMsg createFromParcel(Parcel source) {
            return new RelayRoomHighMsg(source);
        }

        @Override
        public RelayRoomHighMsg[] newArray(int size) {
            return new RelayRoomHighMsg[size];
        }
    };
}
