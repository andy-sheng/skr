 ...
 */
@MessageTag(value = "SKR:CombineRoomMsgHigh", flag = MessageTag.NONE)
public class CustomChatCombineRoomMsg extends MessageContent {
    public final static String TAG = "CustomChatRoomMsg";

    int messageType;
    String contentJsonStr;

    public CustomChatCombineRoomMsg() {

    }

    public CustomChatCombineRoomMsg(byte[] data) {
        String jsonStr = null;
    ...
    public CustomChatCombineRoomMsg(Parcel source) {
     ...
     */
    public static final Creator<CustomChatCombineRoomMsg> CREATOR = new Creator<CustomChatCombineRoomMsg>() {

        @Override
        public CustomChatCombineRoomMsg createFromParcel(Parcel source) {
            return new CustomChatCombineRoomMsg(source);
        }

        @Override
        public CustomChatCombineRoomMsg[] newArray(int size) {
            return new CustomChatCombineRoomMsg[size];
        }
    };
}
