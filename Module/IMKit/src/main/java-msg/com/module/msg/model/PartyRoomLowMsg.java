 ...
 */
@MessageTag(value = "SKR:PartyRoomMsgLow", flag = MessageTag.NONE)
public class PartyRoomLowMsg extends MessageContent {
    public final String TAG = "CustomChatRoomMsg";

    int messageType;
    String contentJsonStr;

    public PartyRoomLowMsg() {

    }

    public PartyRoomLowMsg(byte[] data) {
        String jsonStr = null;
    ...
    public PartyRoomLowMsg(Parcel source) {
     ...
     */
    public static final Creator<PartyRoomLowMsg> CREATOR = new Creator<PartyRoomLowMsg>() {

        @Override
        public PartyRoomLowMsg createFromParcel(Parcel source) {
            return new PartyRoomLowMsg(source);
        }

        @Override
        public PartyRoomLowMsg[] newArray(int size) {
            return new PartyRoomLowMsg[size];
        }
    };
}
