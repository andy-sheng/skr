 ...
 */
@MessageTag(value = "SKR:BattleRoomMsgLow", flag = MessageTag.NONE)
public class BattleRoomLowMsg extends MessageContent {
    public final String TAG = "BattleRoomLowMsg";

    int messageType;
    String contentJsonStr;

    public BattleRoomLowMsg() {

    }

    public BattleRoomLowMsg(byte[] data) {
        String jsonStr = null;
    ...
    public BattleRoomLowMsg(Parcel source) {
     ...
     */
    public static final Creator<BattleRoomLowMsg> CREATOR = new Creator<BattleRoomLowMsg>() {

        @Override
        public BattleRoomLowMsg createFromParcel(Parcel source) {
            return new BattleRoomLowMsg(source);
        }

        @Override
        public BattleRoomLowMsg[] newArray(int size) {
            return new BattleRoomLowMsg[size];
        }
    };
}
