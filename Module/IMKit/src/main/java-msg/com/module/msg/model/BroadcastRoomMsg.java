 ...
 */
@MessageTag(value = "SKR:BroadcastRoomMsg", flag = MessageTag.NONE)
public class BroadcastRoomMsg extends MessageContent {
    public final String TAG = "BroadcastRoomMsg";

    int messageType;
    String contentJsonStr;

    public BroadcastRoomMsg() {

    }

    public BroadcastRoomMsg(byte[] data) {
        String jsonStr = null;
    ...
    public BroadcastRoomMsg(Parcel source) {
     ...
     */
    public static final Creator<BroadcastRoomMsg> CREATOR = new Creator<BroadcastRoomMsg>() {

        @Override
        public BroadcastRoomMsg createFromParcel(Parcel source) {
            return new BroadcastRoomMsg(source);
        }

        @Override
        public BroadcastRoomMsg[] newArray(int size) {
            return new BroadcastRoomMsg[size];
        }
    };
}
