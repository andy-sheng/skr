...
public class AudioPlayManager implements SensorEventListener {
  ...
  public static io.rong.imkit.manager.AudioPlayManager getInstance() {
    return io.rong.imkit.manager.AudioPlayManager.SingletonHolder.sInstance;
  }
      ...
      if (this.mMediaPlayer.isPlaying()) {
        if (range >= event.sensor.getMaximumRange()) {
          ...
          try {
            ...
            FileInputStream fis = new FileInputStream(this.mUriPlaying.getPath());
  ...
  private void setScreenOff() {
    if (this._wakeLock == null) {
      this._wakeLock = this._powerManager.newWakeLock(PowerManager.PROXIMITY_SCREEN_OFF_WAKE_LOCK, "AudioPlayManager");
    }
    ...
    if (context != null && audioUri != null) {
      ...
      this.afChangeListener = new OnAudioFocusChangeListener() {
        public void onAudioFocusChange(int focusChange) {
          ...
          if (io.rong.imkit.manager.AudioPlayManager.this.mAudioManager != null && focusChange == -1) {
            io.rong.imkit.manager.AudioPlayManager.this.mAudioManager.abandonAudioFocus(io.rong.imkit.manager.AudioPlayManager.this.afChangeListener);
            io.rong.imkit.manager.AudioPlayManager.this.afChangeListener = null;
            if (io.rong.imkit.manager.AudioPlayManager.this._playListener != null) {
              io.rong.imkit.manager.AudioPlayManager.this._playListener.onComplete(io.rong.imkit.manager.AudioPlayManager.this.mUriPlaying);
              io.rong.imkit.manager.AudioPlayManager.this._playListener = null;
            }

            io.rong.imkit.manager.AudioPlayManager.this.reset();
          }
  ...
  static class SingletonHolder {
    static io.rong.imkit.manager.AudioPlayManager sInstance = new io.rong.imkit.manager.AudioPlayManager();
