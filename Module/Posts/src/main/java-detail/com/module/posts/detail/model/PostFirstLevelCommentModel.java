...
public class PostFirstLevelCommentModel implements Serializable {
    ...
    public void setComment(FirstLevelCommentBean comment) {
    ...
    public static class FirstLevelCommentBean implements Serializable {
        /**
