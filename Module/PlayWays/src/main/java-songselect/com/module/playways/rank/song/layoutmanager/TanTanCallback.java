...
public class TanTanCallback extends RenRenCallback {
    ...
    public TanTanCallback(RecyclerView rv, RecyclerView.Adapter adapter, List datas, List delDatas) {
        //this(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT, rv, adapter, datas);
        super(rv, adapter, datas,delDatas);
...
/*        if (isLeftSwipe){
        ...
        //自己感受一下吧 Alpha
//        if (viewHolder instanceof SongCardHolder) {
//            SongCardHolder holder = (SongCardHolder) viewHolder;
