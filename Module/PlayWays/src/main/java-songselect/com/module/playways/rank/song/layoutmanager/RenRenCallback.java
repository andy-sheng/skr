package com.module.playways.rank.song.layoutmanager;
...
import static com.module.playways.rank.song.layoutmanager.CardConfig.MAX_SHOW_COUNT;
import static com.module.playways.rank.song.layoutmanager.CardConfig.SCALE_GAP;
import static com.module.playways.rank.song.layoutmanager.CardConfig.TRANS_X_GAP;
import static com.module.playways.rank.song.layoutmanager.CardConfig.TRANS_Y_GAP;
...
public class RenRenCallback extends ItemTouchHelper.SimpleCallback {
    ...
    protected List mDeleteDatas;
    protected RecyclerView.Adapter mAdapter;

    public RenRenCallback(RecyclerView rv, RecyclerView.Adapter adapter, List datas, List deldatas) {
        this(0,
                ItemTouchHelper.DOWN | ItemTouchHelper.UP | ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT,
                rv, adapter, datas, deldatas);
    }

    public RenRenCallback(int dragDirs, int swipeDirs
            , RecyclerView rv, RecyclerView.Adapter adapter, List datas, List deldatas) {
        super(dragDirs, swipeDirs);
        mRv = rv;
        mAdapter = adapter;
        mDatas = datas;
        mDeleteDatas = deldatas;
    }
...
//        mDatas.add(0, remove);
        mDeleteDatas.add(0, remove);
        EventBus.getDefault().post(new SwipCardEvent());
