package com.module.playways.rank.song.flingswipe;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    private ArrayList<View> delItems = new ArrayList<>();
...
//            removeAllViewsInLayout();
            ...
            if (mActiveCard != null && topCard != null && topCard == mActiveCard && !refreshTopView) {
...
//                removeAllViewsInLayout();
     ...
     */
    private void setTopView(boolean refreshTopView) {
        if (getChildCount() > 0) {

            mActiveCard = getChildAt(LAST_OBJECT_IN_STACK);
            if (refreshTopView) {
                mActiveCard.setAnimation(AnimationUtils.loadAnimation(getContext(), R.anim.song_card_del_top_in));
            }
...
//                                Log.e("Log", "onScroll " + progress);
    ...
    public interface onFlingListener {
        ...
        void onCardBack(Object dataObject);
    }
