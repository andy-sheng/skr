...
public class RacePlayerInfoModel extends PlayerInfoModel {
    ...
    public static RacePlayerInfoModel parse(OnlineInfo info) {
        RacePlayerInfoModel grabPlayerInfoModel = new RacePlayerInfoModel();
    ...
    public static RacePlayerInfoModel parse(QJoinNoticeMsg msg) {
        RacePlayerInfoModel grabPlayerInfoModel = new RacePlayerInfoModel();
