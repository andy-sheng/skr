...
public final class MMachineScore extends Message<MMachineScore, MMachineScore.Builder> {
  public static final ProtoAdapter<MMachineScore> ADAPTER = new ProtoAdapter_MMachineScore();
  ...
  public MMachineScore(Integer userID, Integer itemID, Integer score, Integer no, Integer lineNum) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof MMachineScore)) return false;
    MMachineScore o = (MMachineScore) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "MMachineScore{").append('}').toString();
  }

  public byte[] toByteArray() {
    return MMachineScore.ADAPTER.encode(this);
  }

  public static final MMachineScore parseFrom(byte[] data) throws IOException {
    MMachineScore c = null;
       c = MMachineScore.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<MMachineScore, Builder> {
    ...
    @Override
    public MMachineScore build() {
      return new MMachineScore(userID, itemID, score, no, lineNum, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_MMachineScore extends ProtoAdapter<MMachineScore> {
    public ProtoAdapter_MMachineScore() {
      super(FieldEncoding.LENGTH_DELIMITED, MMachineScore.class);
    }

    @Override
    public int encodedSize(MMachineScore value) {
    ...
    @Override
    public void encode(ProtoWriter writer, MMachineScore value) throws IOException {
    ...
    @Override
    public MMachineScore decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public MMachineScore redact(MMachineScore value) {
