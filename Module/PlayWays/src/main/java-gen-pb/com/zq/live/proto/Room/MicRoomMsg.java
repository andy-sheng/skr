...
public final class MicRoomMsg extends Message<MicRoomMsg, MicRoomMsg.Builder> {
  ...
  @WireField(
      tag = 2,
      adapter = "com.zq.live.proto.Room.EMicRoomMsgType#ADAPTER"
  )
  ...
  @WireField(
      tag = 100,
      adapter = "com.zq.live.proto.Room.MJoinActionMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 101,
      adapter = "com.zq.live.proto.Room.MJoinNoticeMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 102,
      adapter = "com.zq.live.proto.Room.MExitGameMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 103,
      adapter = "com.zq.live.proto.Room.MBLightMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 104,
      adapter = "com.zq.live.proto.Room.MGetSingChanceMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 105,
      adapter = "com.zq.live.proto.Room.MSyncStatusMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 106,
      adapter = "com.zq.live.proto.Room.MRoundOverMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 107,
      adapter = "com.zq.live.proto.Room.MAddMusicMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 108,
      adapter = "com.zq.live.proto.Room.MDelMusicMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 109,
      adapter = "com.zq.live.proto.Room.MUpMusicMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 110,
      adapter = "com.zq.live.proto.Room.MReqAddMusicMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 111,
      adapter = "com.zq.live.proto.Room.MChangeRoomNameMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 112,
      adapter = "com.zq.live.proto.Room.MChangeRoomLevelLimitMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 113,
      adapter = "com.zq.live.proto.Room.MKickoutUserMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 114,
      adapter = "com.zq.live.proto.Room.MChangeRoomOwnerMsg#ADAPTER"
  )
  ...
  @WireField(
      tag = 117,
      adapter = "com.zq.live.proto.Room.MMatchStatusMsg#ADAPTER"
  )
