...
public final class CombineRoomMusic extends Message<CombineRoomMusic, CombineRoomMusic.Builder> {
  ...
  public CombineRoomMusic(MusicInfo Music, Integer userID) {
    this(Music, userID, ByteString.EMPTY);
  }

  public CombineRoomMusic(MusicInfo Music, Integer userID, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<CombineRoomMusic, Builder> {
    ...
    public CombineRoomMusic build() {
      return new CombineRoomMusic(Music, userID, super.buildUnknownFields());
    }
  }
