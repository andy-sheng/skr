...
public final class RoundInfo extends Message<RoundInfo, RoundInfo.Builder> {
  ...
  @WireField(
      tag = 6,
      adapter = "com.zq.live.proto.GrabRoom.BLightInfo#ADAPTER",
  ...
  @WireField(
      tag = 7,
      adapter = "com.zq.live.proto.GrabRoom.MLightInfo#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  @WireField(
      tag = 8,
      adapter = "com.zq.live.proto.GrabRoom.ERoundOverReason#ADAPTER"
  )
