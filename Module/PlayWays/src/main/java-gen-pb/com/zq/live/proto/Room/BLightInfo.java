...
public final class BLightInfo extends Message<BLightInfo, BLightInfo.Builder> {
  ...
  public BLightInfo(Integer userID, Long timeMs, Float process) {
    this(userID, timeMs, process, ByteString.EMPTY);
  }

  public BLightInfo(Integer userID, Long timeMs, Float process, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<BLightInfo, Builder> {
    ...
    public BLightInfo build() {
      return new BLightInfo(userID, timeMs, process, super.buildUnknownFields());
    }
  }
