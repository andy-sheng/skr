...
public final class RaceCommonMusic extends Message<RaceCommonMusic, RaceCommonMusic.Builder> {
  public static final ProtoAdapter<RaceCommonMusic> ADAPTER = new ProtoAdapter_RaceCommonMusic();
  ...
  public RaceCommonMusic(Integer itemID, String itemName, String cover, String owner, String lyric,
      ...
      Integer standTotalMs) {
    this(itemID, itemName, cover, owner, lyric, ori, acc, midi, zip, rankBgm, beginMs, endMs, standIntro, standIntroBeginT, standIntroEndT, totalMs, rankLrcBeginT, standLrcBeginT, standLrcEndT, isBlank, standLrc, rankUserVoice, rankLrcEndT, task, standTotalMs, ByteString.EMPTY);
  }
  ...
  public RaceCommonMusic(Integer itemID, String itemName, String cover, String owner, String lyric,
      ...
      Integer totalMs, Integer rankLrcBeginT, Integer standLrcBeginT, Integer standLrcEndT,
      Boolean isBlank, String standLrc, String rankUserVoice, Integer rankLrcEndT, Integer task,
      Integer standTotalMs, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof RaceCommonMusic)) return false;
    RaceCommonMusic o = (RaceCommonMusic) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "RaceCommonMusic{").append('}').toString();
  }

  public byte[] toByteArray() {
    return RaceCommonMusic.ADAPTER.encode(this);
  }

  public static final RaceCommonMusic parseFrom(byte[] data) throws IOException {
    RaceCommonMusic c = null;
       c = RaceCommonMusic.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<RaceCommonMusic, Builder> {
    ...
    @Override
    public RaceCommonMusic build() {
      return new RaceCommonMusic(itemID, itemName, cover, owner, lyric, ori, acc, midi, zip, rankBgm, beginMs, endMs, standIntro, standIntroBeginT, standIntroEndT, totalMs, rankLrcBeginT, standLrcBeginT, standLrcEndT, isBlank, standLrc, rankUserVoice, rankLrcEndT, task, standTotalMs, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_RaceCommonMusic extends ProtoAdapter<RaceCommonMusic> {
    public ProtoAdapter_RaceCommonMusic() {
      super(FieldEncoding.LENGTH_DELIMITED, RaceCommonMusic.class);
    }

    @Override
    public int encodedSize(RaceCommonMusic value) {
    ...
    @Override
    public void encode(ProtoWriter writer, RaceCommonMusic value) throws IOException {
    ...
    @Override
    public RaceCommonMusic decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public RaceCommonMusic redact(RaceCommonMusic value) {
