...
public final class MlightInfo extends Message<MlightInfo, MlightInfo.Builder> {
  ...
  public MlightInfo(Integer userID, Long timeMs) {
    this(userID, timeMs, ByteString.EMPTY);
  }

  public MlightInfo(Integer userID, Long timeMs, ByteString unknownFields) {
  ...
  public static final class Builder extends Message.Builder<MlightInfo, Builder> {
    ...
    public MlightInfo build() {
      return new MlightInfo(userID, timeMs, super.buildUnknownFields());
    }
  }
