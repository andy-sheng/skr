...
public final class MRoundInfo extends Message<MRoundInfo, MRoundInfo.Builder> {
  ...
  @WireField(
      tag = 8,
      adapter = "com.zq.live.proto.Room.EMRoundStatus#ADAPTER"
  )
  ...
  @WireField(
      tag = 9,
      adapter = "com.zq.live.proto.Room.EMRoundOverReason#ADAPTER"
  )
  ...
  @WireField(
      tag = 12,
      adapter = "com.zq.live.proto.Room.MOnlineInfo#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  @WireField(
      tag = 14,
      adapter = "com.zq.live.proto.Room.MCHOInnerRoundInfo#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  @WireField(
      tag = 15,
      adapter = "com.zq.live.proto.Room.MSPKInnerRoundInfo#ADAPTER",
      label = WireField.Label.REPEATED
  )
