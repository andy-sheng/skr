...
public final class QRoundInfo extends Message<QRoundInfo, QRoundInfo.Builder> {
  ...
  @WireField(
      tag = 8,
      adapter = "com.zq.live.proto.GrabRoom.EQRoundStatus#ADAPTER"
  )
  ...
  @WireField(
      tag = 9,
      adapter = "com.zq.live.proto.GrabRoom.WantSingInfo#ADAPTER",
  ...
  @WireField(
      tag = 10,
      adapter = "com.zq.live.proto.GrabRoom.EQRoundOverReason#ADAPTER"
  )
  ...
  @WireField(
      tag = 11,
      adapter = "com.zq.live.proto.GrabRoom.EQRoundResultType#ADAPTER"
  )
  ...
  @WireField(
      tag = 19,
      adapter = "com.zq.live.proto.GrabRoom.EWantSingType#ADAPTER"
  )
  ...
  @WireField(
      tag = 20,
      adapter = "com.zq.live.proto.GrabRoom.QCHOInnerRoundInfo#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  @WireField(
      tag = 21,
      adapter = "com.zq.live.proto.GrabRoom.QSPKInnerRoundInfo#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  @WireField(
      tag = 22,
      adapter = "com.zq.live.proto.GrabRoom.QMINIGameInnerRoundInfo#ADAPTER",
      label = WireField.Label.REPEATED
  )
  ...
  public List<QMINIGameInnerRoundInfo> getMINIGAMERoundInfosList() {
    if(MINIGAMERoundInfos==null){
        return new java.util.ArrayList<QMINIGameInnerRoundInfo>();
    }
  ...
  public static final class Builder extends Message.Builder<QRoundInfo, Builder> {
     ...
     * 一唱到底连麦小游戏：内部轮次信息
     */
    public Builder addAllMINIGAMERoundInfos(List<QMINIGameInnerRoundInfo> MINIGAMERoundInfos) {
      Internal.checkElementsNotNull(MINIGAMERoundInfos);
      this.MINIGAMERoundInfos = MINIGAMERoundInfos;
      return this;
    }
