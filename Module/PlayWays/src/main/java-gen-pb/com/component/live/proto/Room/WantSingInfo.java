...
public final class WantSingInfo extends Message<WantSingInfo, WantSingInfo.Builder> {
  public static final ProtoAdapter<WantSingInfo> ADAPTER = new ProtoAdapter_WantSingInfo();
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof WantSingInfo)) return false;
  ...
  public byte[] toByteArray() {
    return WantSingInfo.ADAPTER.encode(this);
  }

  public static final WantSingInfo parseFrom(byte[] data) throws IOException {
    WantSingInfo c = null;
       c = WantSingInfo.ADAPTER.decode(data);
    return c;
  }
  ...
  private static final class ProtoAdapter_WantSingInfo extends ProtoAdapter<WantSingInfo> {
    public ProtoAdapter_WantSingInfo() {
      super(FieldEncoding.LENGTH_DELIMITED, WantSingInfo.class);
    }
    ...
    @Override
    public WantSingInfo decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public WantSingInfo redact(WantSingInfo value) {
