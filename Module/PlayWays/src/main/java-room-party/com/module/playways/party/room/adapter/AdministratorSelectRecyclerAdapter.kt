...
class AdministratorSelectRecyclerAdapter : RecyclerView.Adapter<AdministratorSelectRecyclerAdapter.ChangeHostHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChangeHostHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.administrator_select_adapter_item_layout, parent, false)
