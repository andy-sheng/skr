...
public class DownLoadScoreFilePresenter extends RxLifeCyclePresenter {
    ...
    List<PlayerInfo>  mPlayerInfos;

    public DownLoadScoreFilePresenter(@NotNull HttpUtils.OnDownloadProgress onDownloadProgress, List<PlayerInfo> playerInfoList){
        mOnDownloadProgress = onDownloadProgress;
        mPlayerInfos = playerInfoList;
    }
