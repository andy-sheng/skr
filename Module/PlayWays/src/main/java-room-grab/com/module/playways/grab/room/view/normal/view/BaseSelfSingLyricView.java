...
public abstract class BaseSelfSingLyricView extends RelativeLayout {
    ...
    public BaseSelfSingLyricView(Context context) {
        super(context);
        init();
    }

    public BaseSelfSingLyricView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BaseSelfSingLyricView(Context context, AttributeSet attrs, int defStyleAttr) {
