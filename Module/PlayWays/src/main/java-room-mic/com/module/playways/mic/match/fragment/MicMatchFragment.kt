package com.module.playways.mic.match.fragment
...
import com.module.playways.mic.match.IMicMatchingView
...
class MicMatchFragment : BaseFragment(), IMicMatchingView {
    ...
    internal var mMatchPresenter: MicMatchPresenter? = null
    ...
    override fun initData(savedInstanceState: Bundle?) {
        ...
        mMatchPresenter = MicMatchPresenter(this)
...
//                        }
    ...
    //竞赛
    override fun matchRaceSucess(joinMicRoomRspModel: JoinMicRoomRspModel) {
        MyLog.d(TAG, "matchSucess event=$joinMicRoomRspModel")
        BgMusicManager.getInstance().destory()
        stopTimeTask()

        //先跳转
        ARouter.getInstance().build(RouterConstants.ACTIVITY_MIC_ROOM)
                .withSerializable("JoinMicRoomRspModel", joinMicRoomRspModel)
                .navigation()
