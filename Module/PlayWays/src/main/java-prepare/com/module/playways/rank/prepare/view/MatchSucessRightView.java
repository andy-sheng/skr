...
public class MatchSucessRightView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int[] point2 = new int[]{U.getDisplayUtils().getScreenWidth() / 2, 0};
        path.lineTo(point2[0], point2[1]);
        int[] point3 = new int[]{U.getDisplayUtils().getScreenWidth(), 0};
        path.lineTo(point3[0], point3[1]);
        int[] point4 = new int[]{U.getDisplayUtils().getScreenWidth(), U.getDisplayUtils().getScreenHeight() / 2 + U.getDisplayUtils().getScreenWidth() / 2};
