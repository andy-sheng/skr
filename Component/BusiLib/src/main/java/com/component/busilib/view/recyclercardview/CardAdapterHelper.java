package com.component.busilib.view.recyclercardview;
...
public class CardAdapterHelper {
    ...
    public void onCreateViewHolder(ViewGroup parent, View itemView) {
        ...
        lp.width = parent.getWidth() - U.getDisplayUtils().dip2px(itemView.getContext(), 2 * (mPagePadding + mShowLeftCardWidth));
