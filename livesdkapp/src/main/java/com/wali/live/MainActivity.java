    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ($(R.id.replay_tv)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RoomInfo roomInfo = RoomInfo.Builder.newInstance(100067, "100067_1497257817",
                        "http://playback.ks.zb.mi.com/record/live/100067_1497257817/hls/100067_1497257817.m3u8?playui=0")
                        .setLiveType(6)
                        .setEnableShare(true)
                        .build();
