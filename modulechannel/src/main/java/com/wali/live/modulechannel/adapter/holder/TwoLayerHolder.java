...
public class TwoLayerHolder extends RepeatHolder {
    ...
    protected void changeImageSize() {
        ...
        mlp.width = U.getDisplayUtils().getScreenWidth() - SIDE_MARGIN * 2;
    ...
    protected int getImageWidth() {
        return (U.getDisplayUtils().getScreenWidth() - SIDE_MARGIN * 2 - MIDDLE_MARGIN_TWO) / 2;
    }

    @Override
    protected int getImageHeight() {
        return U.getDisplayUtils().dip2px(99f);
    }
