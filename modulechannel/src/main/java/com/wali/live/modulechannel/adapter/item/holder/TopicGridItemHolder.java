package com.wali.live.modulechannel.adapter.item.holder;
...
public class TopicGridItemHolder extends RecyclerView.ViewHolder {
    ...
    private ChannelNavigateViewModel.NavigateItem mItemData;
    ...
    public void bindModel(ChannelNavigateViewModel.NavigateItem itemData) {
        mItemData = itemData;
        bindView();
    }
    ...
    private ColorStateList createSelector(ChannelNavigateViewModel.NavigateItem mItemData) {
