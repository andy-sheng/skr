package com.wali.live.modulechannel.model.channellist;


import com.wali.live.proto.LiveShow.ChannelShow;

public class ChannelShowModel {
    ...
    public static ChannelShowModel parseFromPb(ChannelShow cs) {
        ChannelShowModel channelShow = new ChannelShowModel();
