...
import com.common.core.commonview.MovableImageView;
...
public class EffectCardHolder extends FixedHolder implements IEffectScrollHolder {
    ...
    protected int getImageHeight() {
        // 比例按设计尺寸
        return (int) (U.getDisplayUtils().getScreenWidth() * EFFECT_IMAGE_RATIO);
    }
    ...
    protected void bindLiveModel(ChannelLiveViewModel model) {
        ...
        bindImageWithCallback(mCoverIv, item.getImageUrl(ImageUtils.SIZE.SIZE_640), false, 640, 640, ScalingUtils.ScaleType.CENTER_CROP
                , new IFrescoCallBack() {
            @Override
...
//            mTitleTv.setMovementMethod(new LinkMovementMethod());
        ...
        if (item.getUser() != null) {
            ...
            bindText(mNameTv, item.getUser().getUserNickname());
        } else {
