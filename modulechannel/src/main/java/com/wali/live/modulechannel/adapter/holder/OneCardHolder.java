...
public class OneCardHolder extends FixedHolder {
    ...
    protected void bindItemOnLiveModel(ChannelLiveViewModel.BaseItem item) {
        ...
        if (item.getUser() != null) {
            ...
            String avatarUrl = AvatarUtils.getAvatarUrlByCustom(item.getUser().getUserId(),
                    ImageUtils.SIZE.SIZE_480, item.getUser().getAvatar(), false);
            ...
            bindText(mDisplayTv, item.getUser().getUserNickname());
        } else {
