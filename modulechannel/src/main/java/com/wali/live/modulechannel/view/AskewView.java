...
public class AskewView extends TextView {
    ...
    private void setAttrs(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ChannelAskewView);
        mAdjustDistance = a.getDimensionPixelSize(R.styleable.ChannelAskewView_channel_adjustDistance, 0);
        a.recycle();
    }
