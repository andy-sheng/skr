 ...
 */
public final class GetWaterfallSubListReq extends Message<GetWaterfallSubListReq, GetWaterfallSubListReq.Builder> {
  public static final ProtoAdapter<GetWaterfallSubListReq> ADAPTER = new ProtoAdapter_GetWaterfallSubListReq();
  ...
  public GetWaterfallSubListReq(Long uid, Integer oper_type, Integer channel_id, ByteString param,
      Location location) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GetWaterfallSubListReq)) return false;
    GetWaterfallSubListReq o = (GetWaterfallSubListReq) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "GetWaterfallSubListReq{").append('}').toString();
  }

  public byte[] toByteArray() {
    return GetWaterfallSubListReq.ADAPTER.encode(this);
  }
  ...
  public static final class Builder extends Message.Builder<GetWaterfallSubListReq, Builder> {
    ...
    public GetWaterfallSubListReq build() {
      ...
      return new GetWaterfallSubListReq(uid, oper_type, channel_id, param, location, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_GetWaterfallSubListReq extends ProtoAdapter<GetWaterfallSubListReq> {
    public ProtoAdapter_GetWaterfallSubListReq() {
      super(FieldEncoding.LENGTH_DELIMITED, GetWaterfallSubListReq.class);
    }

    @Override
    public int encodedSize(GetWaterfallSubListReq value) {
    ...
    @Override
    public void encode(ProtoWriter writer, GetWaterfallSubListReq value) throws IOException {
    ...
    @Override
    public GetWaterfallSubListReq decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public GetWaterfallSubListReq redact(GetWaterfallSubListReq value) {
