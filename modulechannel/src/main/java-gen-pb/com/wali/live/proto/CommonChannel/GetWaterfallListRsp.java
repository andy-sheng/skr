...
public final class GetWaterfallListRsp extends Message<GetWaterfallListRsp, GetWaterfallListRsp.Builder> {
  public static final ProtoAdapter<GetWaterfallListRsp> ADAPTER = new ProtoAdapter_GetWaterfallListRsp();
  ...
  public GetWaterfallListRsp(Integer ret, List<WatElement> elem, ByteString param,
      Boolean has_more) {
    this(ret, elem, param, has_more, ByteString.EMPTY);
  }

  public GetWaterfallListRsp(Integer ret, List<WatElement> elem, ByteString param, Boolean has_more,
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof GetWaterfallListRsp)) return false;
    GetWaterfallListRsp o = (GetWaterfallListRsp) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "GetWaterfallListRsp{").append('}').toString();
  }

  public static final GetWaterfallListRsp parseFrom(byte[] data) throws IOException {
    GetWaterfallListRsp c = null;
       c = GetWaterfallListRsp.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<GetWaterfallListRsp, Builder> {
    public Integer ret;
    ...
    @Override
    public GetWaterfallListRsp build() {
      return new GetWaterfallListRsp(ret, elem, param, has_more, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_GetWaterfallListRsp extends ProtoAdapter<GetWaterfallListRsp> {
    public ProtoAdapter_GetWaterfallListRsp() {
      super(FieldEncoding.LENGTH_DELIMITED, GetWaterfallListRsp.class);
    }

    @Override
    public int encodedSize(GetWaterfallListRsp value) {
    ...
    @Override
    public void encode(ProtoWriter writer, GetWaterfallListRsp value) throws IOException {
    ...
    @Override
    public GetWaterfallListRsp decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public GetWaterfallListRsp redact(GetWaterfallListRsp value) {
