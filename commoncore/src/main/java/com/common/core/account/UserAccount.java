...
public class UserAccount {
    ...
    public UserAccount(Long id, @NotNull String uid, String password,
                       ...
                       String serviceToken, String secretToken, String rongToken, int fromLoginMode, String ext) {
        this.id = id;
        this.uid = uid;
        ...
        this.fromLoginMode = fromLoginMode;
        this.ext = ext;
    }
    ...
    public int getFromLoginMode() {
        return fromLoginMode;
    }

    public void setFromLoginMode(int fromLoginMode) {
        this.fromLoginMode = fromLoginMode;
    }
}
