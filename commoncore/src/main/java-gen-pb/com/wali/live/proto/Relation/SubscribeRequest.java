 ...
 * 订阅请求
 */
public final class SubscribeRequest extends Message<SubscribeRequest, SubscribeRequest.Builder> {
  ...
  public SubscribeRequest(Long userId, Long targetId) {
    this(userId, targetId, ByteString.EMPTY);
  }

  public SubscribeRequest(Long userId, Long targetId, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof SubscribeRequest)) return false;
    SubscribeRequest o = (SubscribeRequest) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "SubscribeRequest{").append('}').toString();
  }

  public byte[] toByteArray() {
    return SubscribeRequest.ADAPTER.encode(this);
  }
  ...
  public static final class Builder extends Message.Builder<SubscribeRequest, Builder> {
    ...
    public SubscribeRequest build() {
      ...
      return new SubscribeRequest(userId, targetId, super.buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_SubscribeRequest extends ProtoAdapter<SubscribeRequest> {
    ...
    @Override
    public int encodedSize(SubscribeRequest value) {
    ...
    @Override
    public void encode(ProtoWriter writer, SubscribeRequest value) throws IOException {
    ...
    @Override
    public SubscribeRequest decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public SubscribeRequest redact(SubscribeRequest value) {
