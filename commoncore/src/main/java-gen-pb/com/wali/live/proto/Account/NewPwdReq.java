 ...
 */
public final class NewPwdReq extends Message<NewPwdReq, NewPwdReq.Builder> {
  public static final ProtoAdapter<NewPwdReq> ADAPTER = new ProtoAdapter_NewPwdReq();
  ...
  public NewPwdReq(String phoneNum, String pwd, String captcha) {
    this(phoneNum, pwd, captcha, ByteString.EMPTY);
  }

  public NewPwdReq(String phoneNum, String pwd, String captcha, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof NewPwdReq)) return false;
    NewPwdReq o = (NewPwdReq) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "NewPwdReq{").append('}').toString();
  }

  public byte[] toByteArray() {
    return NewPwdReq.ADAPTER.encode(this);
  }

  public static final class Builder extends Message.Builder<NewPwdReq, Builder> {
    ...
    public NewPwdReq build() {
      ...
      return new NewPwdReq(phoneNum, pwd, captcha, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_NewPwdReq extends ProtoAdapter<NewPwdReq> {
    public ProtoAdapter_NewPwdReq() {
      super(FieldEncoding.LENGTH_DELIMITED, NewPwdReq.class);
    }

    @Override
    public int encodedSize(NewPwdReq value) {
    ...
    @Override
    public void encode(ProtoWriter writer, NewPwdReq value) throws IOException {
    ...
    @Override
    public NewPwdReq decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public NewPwdReq redact(NewPwdReq value) {
