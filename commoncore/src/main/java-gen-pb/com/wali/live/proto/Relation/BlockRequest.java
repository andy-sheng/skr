 ...
 * 拉黑请求
 */
public final class BlockRequest extends Message<BlockRequest, BlockRequest.Builder> {
  public static final ProtoAdapter<BlockRequest> ADAPTER = new ProtoAdapter_BlockRequest();
  ...
  public BlockRequest(Long userId, Long targetId) {
    this(userId, targetId, ByteString.EMPTY);
  }

  public BlockRequest(Long userId, Long targetId, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof BlockRequest)) return false;
    BlockRequest o = (BlockRequest) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "BlockRequest{").append('}').toString();
  }

  public byte[] toByteArray() {
    return BlockRequest.ADAPTER.encode(this);
  }
  ...
  public static final class Builder extends Message.Builder<BlockRequest, Builder> {
    ...
    public BlockRequest build() {
      ...
      return new BlockRequest(userId, targetId, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_BlockRequest extends ProtoAdapter<BlockRequest> {
    public ProtoAdapter_BlockRequest() {
      super(FieldEncoding.LENGTH_DELIMITED, BlockRequest.class);
    }

    @Override
    public int encodedSize(BlockRequest value) {
    ...
    @Override
    public void encode(ProtoWriter writer, BlockRequest value) throws IOException {
    ...
    @Override
    public BlockRequest decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public BlockRequest redact(BlockRequest value) {
