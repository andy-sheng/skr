...
public final class UserInfo extends Message<UserInfo, UserInfo.Builder> {
  ...
  @WireField(
      tag = 11,
      adapter = "com.zq.live.proto.Common.UClubInfo#ADAPTER"
  )
  private final UClubInfo clubInfo;
   ...
   * 家族信息
   */
  public UClubInfo getClubInfo() {
    if(clubInfo==null){
        return new UClubInfo.Builder().build();
    }
    return clubInfo;
  }
  ...
  public static final class Builder extends Message.Builder<UserInfo, Builder> {
     ...
     * 家族信息
     */
    public Builder setClubInfo(UClubInfo clubInfo) {
      this.clubInfo = clubInfo;
      return this;
    }
  ...
  private static final class ProtoAdapter_UserInfo extends ProtoAdapter<UserInfo> {
    ...
    public int encodedSize(UserInfo value) {
      return ProtoAdapter.UINT32.encodedSizeWithTag(1, value.userID)
          ...
          + UClubInfo.ADAPTER.encodedSizeWithTag(11, value.clubInfo)
    ...
    public void encode(ProtoWriter writer, UserInfo value) throws IOException {
      ...
      UClubInfo.ADAPTER.encodeWithTag(writer, 11, value.clubInfo);
    ...
    public UserInfo decode(ProtoReader reader) throws IOException {
      ...
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
          ...
          case 11: builder.setClubInfo(UClubInfo.ADAPTER.decode(reader)); break;
          default: {
    ...
    public UserInfo redact(UserInfo value) {
      ...
      if (builder.clubInfo != null) builder.clubInfo = UClubInfo.ADAPTER.redact(builder.clubInfo);
