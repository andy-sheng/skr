...
public final class StartCombineRoomByMatchMsg extends Message<StartCombineRoomByMatchMsg, StartCombineRoomByMatchMsg.Builder> {
  public static final ProtoAdapter<StartCombineRoomByMatchMsg> ADAPTER = new ProtoAdapter_StartCombineRoomByMatchMsg();
  ...
  public StartCombineRoomByMatchMsg(Integer roomID, Long createdTimeMs, Long passedTimeMs,
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof StartCombineRoomByMatchMsg)) return false;
    StartCombineRoomByMatchMsg o = (StartCombineRoomByMatchMsg) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "StartCombineRoomByMatchMsg{").append('}').toString();
  }

  public byte[] toByteArray() {
    return StartCombineRoomByMatchMsg.ADAPTER.encode(this);
  }

  public static final StartCombineRoomByMatchMsg parseFrom(byte[] data) throws IOException {
    StartCombineRoomByMatchMsg c = null;
       c = StartCombineRoomByMatchMsg.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<StartCombineRoomByMatchMsg, Builder> {
    ...
    public StartCombineRoomByMatchMsg build() {
      return new StartCombineRoomByMatchMsg(roomID, createdTimeMs, passedTimeMs, users, config, tokens, needMaskUserInfo, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_StartCombineRoomByMatchMsg extends ProtoAdapter<StartCombineRoomByMatchMsg> {
    public ProtoAdapter_StartCombineRoomByMatchMsg() {
      super(FieldEncoding.LENGTH_DELIMITED, StartCombineRoomByMatchMsg.class);
    }

    @Override
    public int encodedSize(StartCombineRoomByMatchMsg value) {
    ...
    @Override
    public void encode(ProtoWriter writer, StartCombineRoomByMatchMsg value) throws IOException {
    ...
    @Override
    public StartCombineRoomByMatchMsg decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public StartCombineRoomByMatchMsg redact(StartCombineRoomByMatchMsg value) {
