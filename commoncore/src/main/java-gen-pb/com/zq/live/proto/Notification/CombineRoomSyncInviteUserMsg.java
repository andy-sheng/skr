...
public final class CombineRoomSyncInviteUserMsg extends Message<CombineRoomSyncInviteUserMsg, CombineRoomSyncInviteUserMsg.Builder> {
  public static final ProtoAdapter<CombineRoomSyncInviteUserMsg> ADAPTER = new ProtoAdapter_CombineRoomSyncInviteUserMsg();
  ...
  public CombineRoomSyncInviteUserMsg(Integer roomID, Long createdTimeMs, Long passedTimeMs,
      List<UserInfo> users, CombineRoomConfig config, List<AgoraTokenInfo> tokens,
      Boolean needMaskUserInfo) {
    this(roomID, createdTimeMs, passedTimeMs, users, config, tokens, needMaskUserInfo, ByteString.EMPTY);
  }

  public CombineRoomSyncInviteUserMsg(Integer roomID, Long createdTimeMs, Long passedTimeMs,
      List<UserInfo> users, CombineRoomConfig config, List<AgoraTokenInfo> tokens,
      Boolean needMaskUserInfo, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof CombineRoomSyncInviteUserMsg)) return false;
    CombineRoomSyncInviteUserMsg o = (CombineRoomSyncInviteUserMsg) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "CombineRoomSyncInviteUserMsg{").append('}').toString();
  }

  public byte[] toByteArray() {
    return CombineRoomSyncInviteUserMsg.ADAPTER.encode(this);
  }

  public static final CombineRoomSyncInviteUserMsg parseFrom(byte[] data) throws IOException {
    CombineRoomSyncInviteUserMsg c = null;
       c = CombineRoomSyncInviteUserMsg.ADAPTER.decode(data);
    return c;
  }
  ...
  public static final class Builder extends Message.Builder<CombineRoomSyncInviteUserMsg, Builder> {
    ...
    @Override
    public CombineRoomSyncInviteUserMsg build() {
      return new CombineRoomSyncInviteUserMsg(roomID, createdTimeMs, passedTimeMs, users, config, tokens, needMaskUserInfo, super.buildUnknownFields());
    }
  }

  private static final class ProtoAdapter_CombineRoomSyncInviteUserMsg extends ProtoAdapter<CombineRoomSyncInviteUserMsg> {
    public ProtoAdapter_CombineRoomSyncInviteUserMsg() {
      super(FieldEncoding.LENGTH_DELIMITED, CombineRoomSyncInviteUserMsg.class);
    }

    @Override
    public int encodedSize(CombineRoomSyncInviteUserMsg value) {
      return ProtoAdapter.UINT32.encodedSizeWithTag(2, value.roomID)
    ...
    @Override
    public void encode(ProtoWriter writer, CombineRoomSyncInviteUserMsg value) throws IOException {
    ...
    @Override
    public CombineRoomSyncInviteUserMsg decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
    ...
    @Override
    public CombineRoomSyncInviteUserMsg redact(CombineRoomSyncInviteUserMsg value) {
