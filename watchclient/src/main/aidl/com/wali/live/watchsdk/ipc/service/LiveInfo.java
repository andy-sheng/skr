...
public class LiveInfo implements Parcelable {
    ...
    public LiveInfo(CommonChannelProto.LiveInfo liveInfo) {
        ...
        CommonChannelProto.UserBrief userBrief = liveInfo.getUser();
        if (userBrief != null) {
            this.mUserId = userBrief.getUId();
            this.mNickname = userBrief.getNickname();
            this.mAvatar = userBrief.getAvatar();
            this.mLevel = userBrief.getLevel();
            this.mCertType = userBrief.getCertType();
        }
        this.mCity = liveInfo.getLocation();
        this.mViewerCnt = liveInfo.getViewerCnt();
        this.mUrl = liveInfo.getUrl();
        this.mCoverUrl = liveInfo.getCoverUrl();
        this.mLiveTitle = liveInfo.getLiTitle();
        this.mStartTime = liveInfo.getStartTime();
        this.mTag = liveInfo.getTag();
        this.mAppType = liveInfo.getAppType();
        this.mLiveType = liveInfo.getLiveType();
    }
