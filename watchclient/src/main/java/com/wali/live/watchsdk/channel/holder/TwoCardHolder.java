...
public class TwoCardHolder extends RepeatHolder {
    ...
    protected void initContentView() {
        ...
        mImageBorderWidth = 0;
        mItemWidth = (DisplayUtils.getScreenWidth() - SIDE_MARGIN * 2 - MIDDLE_MARGIN_TWO) / 2;
        ...
        for (int i = 0; i < mViewSize; i++) {
            ...
            if (i == mViewSize - 1) {
                ...
                int leftWidth = DisplayUtils.getScreenWidth() - SIDE_MARGIN * 2 - MIDDLE_MARGIN_TWO - childWidth;
     ...
     * @param i
     */
    protected void bindDisplayText(BaseItem item, int i) {
