...
public class ChannelPageHeaderViewModel extends ChannelNavigateViewModel {
    ...
    public ChannelPageHeaderViewModel(CommonChannelProto.ChannelItem protoItem) throws Exception {
        super(protoItem);
    }
    ...
    protected void parseTemplate(CommonChannelProto.ChannelItem protoItem) throws Exception {
        ...
        parsePageHeader(CommonChannelProto.UiTemplatePageHeader.parseFrom(protoItem.getUiData()));
    }

    protected void parsePageHeader(CommonChannelProto.UiTemplatePageHeader header) {
