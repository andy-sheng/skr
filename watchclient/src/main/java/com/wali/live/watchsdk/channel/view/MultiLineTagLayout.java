...
public class MultiLineTagLayout extends RelativeLayout implements IFoldViewContent {
    ...
    private static final int MARGIN_BETWEEN_ITEMS = DisplayUtils.dip2px(10);
    private static final int MARGIN_BETWEEN_LINES = DisplayUtils.dip2px(10);
    private static final int ITEM_HEIGHT = DisplayUtils.dip2px(30);
    private static final int ITEM_ROUND_CORNER = DisplayUtils.dip2px(20);
    private static final int ITEM_STROKE_WIDTH = DisplayUtils.dip2px(0.66f);
    ...
    private int mSearchTagLeftAndRightPadding = DisplayUtils.dip2px(13.33f);     //热门搜索　每个tag的padding


    private static final int[] ITEMCOLORS = {
            R.color.color_channel_tag_stroke_bg_1,
            R.color.color_channel_tag_stroke_bg_2,
            R.color.color_channel_tag_stroke_bg_3};
    ...
    private Drawable generateColorfulDrawable(int color) {
        ...
        pressedDrawable.setColor(getContext().getResources().getColor(R.color.color_black_trans_6));
