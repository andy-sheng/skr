...
//        canvas.restore();
    ...
    public void setIsCanChange(boolean canChange) {
...
//                / 2;
            ...
            for (int i = 0; i < mTabTitles.size(); i++) {
                ...
                if (canChange) {
                    ...
                    if (i == 0) {
                        ...
                        addView(generateUnClickTextView(mTabTitles.get(i)));
                    }
                }
            }
            // 设置item的click事件
    ...
    public void setTxtColor(int normal, int selected) {
        COLOR_TEXT_NORMAL = normal;
        COLOR_TEXT_HIGHLIGHTCOLOR = selected;
        resetTextViewColor();
    }
    ...
    private TextView generateTextView(String text) {
        ...
        tv.setTextColor(getContext().getResources().getColor(R.color.color_black_trans_80));
        tv.setText(text);
        tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, 44);
    ...
    private View generateSplitView() {
        ...
        LayoutParams lp = new LayoutParams(DisplayUtils.dip2px(getContext(), 1), DisplayUtils.dip2px(getContext(), 20));
    ...
    private TextView generateUnClickTextView(String text) {
        ...
        lp.width = getScreenWidth() / mTabVisibleCount;
        tv.setGravity(Gravity.CENTER);
        tv.setTextColor(getContext().getResources().getColor(R.color.gray_primary_bg));
        tv.setText(text);
        ...
        for (int i = 0; i < count; i++) {
            if (i == 0) {
                ...
                if (view instanceof TextView) {
                    ...
                    ((TextView) view).setPadding(0, 0, 60, 0);
                }
            }
            ...
            if (i == 1) {
                ...
                if (view instanceof TextView) {
                    ...
                    ((TextView) view).setPadding(60, 0, 0, 0);
                }
            }
        }
    }
