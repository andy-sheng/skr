...
public class FansListFragment extends BaseFragment {
    ...
    protected void bindView() {
        ...
        mTitleBar.getBackBtn().setText(GlobalData.app().getResources().getString(R.string.fans));
    ...
    public static void openFragment(Activity activity, int containerId, long uuid) {
        ...
        bundle.putLong(FansListFragment.EXTRA_IN_USER_UUID, uuid);
        FragmentNaviUtils.addFragment((BaseSdkActivity) activity, containerId, FansListFragment.class, bundle, true, true, true);
    }
}
