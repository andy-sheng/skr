    ...
    protected void initContentView() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            int width = (DisplayUtils.getScreenWidth() -
                    GlobalData.app().getResources().getDimensionPixelSize(R.dimen.view_dimen_20) * 2
                    - GlobalData.app().getResources().getDimensionPixelSize(R.dimen.view_dimen_18)) / 2;
        ...
        for (int i = 0; i < mParentIds.length; i ++) {
            ...
            if (baseLiveItem instanceof ChannelLiveViewModel.LiveItem) {
                ...
                if (((ChannelLiveViewModel.LiveItem) baseLiveItem).isMiLive()) {
                    mAppTypeIcons[i].setImageDrawable(GlobalData.app().getResources().getDrawable(R.drawable.logo_xiaomi_small));
                } else if (((ChannelLiveViewModel.LiveItem) baseLiveItem).isHuyaLive()) {
                    mAppTypeIcons[i].setImageDrawable(GlobalData.app().getResources().getDrawable(R.drawable.logo_huya_small));
                } else if (((ChannelLiveViewModel.LiveItem) baseLiveItem).isPandaLive()) {
                    mAppTypeIcons[i].setImageDrawable(GlobalData.app().getResources().getDrawable(R.drawable.logo_panda_small));
                } else {
