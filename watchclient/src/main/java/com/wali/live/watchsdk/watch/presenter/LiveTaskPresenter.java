...
public class LiveTaskPresenter implements ILiveTaskPresenter, IBindActivityLIfeCycle {
    ...
    public LiveTaskPresenter(@NonNull RxActivity rxActivity,
                             IWatchView view,
        ...
        mEnterRoomSubscription = LiveRoomQuery.enterRoom(mMyRoomData.getUid(), mMyRoomData.getRoomId(), "")
                ...
                .subscribe(new Observer<EnterRoomInfo>() {
                    ...
                    public void onNext(EnterRoomInfo enterRoomInfo) {
                        ...
                        if (mMyRoomData.getGetMessageMode() == RoomMessagePresenter.PULL_MODE
                            ...
                            if (mPullRoomMessagePresenter == null) {
                                mPullRoomMessagePresenter = new RoomMessagePresenter(mMyRoomData,
                                        new RoomMessageRepository(new RoomMessageStore()), mRxActivity);
                            }
                        ...
                        if (mView != null && enterRoomInfo.getRetCode() == ErrorCode.CODE_SUCCESS) {
                        ...
                        } else if (mView != null && enterRoomInfo.getRetCode() ==
                                ErrorCode.CODE_SERVER_RESPONSE_ERROR_CODE_NO_PERMISSION_TO_ENTER_ROOM) {
                            ...
                            BarrageMsg msg = SendBarrageManager.createBarrage(BarrageMsgType.B_MSG_TYPE_LIVE_END,
                                    GlobalData.app().getString(R.string.live_finish), mMyRoomData.getRoomId(),
                                    mMyRoomData.getUid(), System.currentTimeMillis(), ext);
    ...
    public void leaveLive() {
        ...
        LiveRoomQuery.leaveRoom(mMyRoomData.getUid(), mMyRoomData.getRoomId(),
                mMyRoomData.getGetMessageMode())
