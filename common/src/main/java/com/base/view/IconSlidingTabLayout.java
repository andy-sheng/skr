...
/**
 * <p/>
 * 和IconFragmentPagerAdapter一起使用，用来支持图标
 * <p/>
 * 和SlidingTabLayout一致，修改范围：
 * populateTabStrip()
...
public class IconSlidingTabLayout extends HorizontalScrollView {
    ...
    /**
     * Set the {@link ViewPager.OnPageChangeListener}. When using {@link IconSlidingTabLayout} you are
    ...
    private void populateTabStrip() {
        final IconFragmentPagerAdapter adapter = (IconFragmentPagerAdapter) mViewPager.getAdapter();
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabIconView != null) {
                tabIconView.setImageResource(adapter.getIconResId(i));
            }
