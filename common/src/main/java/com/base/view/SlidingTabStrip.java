...
import static com.base.view.SlidingTabLayout.ANI_MODE_NORMAL;
import static com.base.view.SlidingTabLayout.ANI_MODE_TAIL;
...
class SlidingTabStrip extends LinearLayout {
    ...
    private int mIndicatorAnimationMode = ANI_MODE_NORMAL;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (childCount > 0) {
            ...
            if(null != selectedTitle) {
                ...
                float leftMargin = 0 ;
                if (mIndicatorAnimationMode == ANI_MODE_TAIL && mIndicatorWidth > 0) {
                ...
                if (mIndicatorAnimationMode == ANI_MODE_NORMAL && mIndicatorWidth > 0) {
                    leftMargin = (right - left - mIndicatorWidth) / 2.0f;
                }
                // 绘制Indicator（指示器）
