...
-keep class com.mi.liveassistant.account.AccountManager{
    public *;
}

-keep class com.mi.liveassistant.account.callback.IAccountListener{
    *;
}

-keep class com.mi.liveassistant.account.callback.IAccountCallback{
    *;
}
