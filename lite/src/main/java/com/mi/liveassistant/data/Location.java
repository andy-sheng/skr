...
public class Location implements Parcelable {
    ...
    public Location(LiveCommonProto.Location protoLocation) {
        parse(protoLocation);
    }
    ...
    public void parse(LiveCommonProto.Location protoLocation) {
    ...
    public LiveCommonProto.Location build() {
        LiveCommonProto.Location protoLocation = LiveCommonProto.Location.newBuilder()
                .setLon(lon)
                .setLat(lat)
