...
public class Viewer {
    ...
    public Viewer(ViewerModel viewerModel) {
        mUid = viewerModel.getUid();
        mLevel = viewerModel.getLevel();
        mAvatar = viewerModel.getAvatar();
        mCertificationType = viewerModel.getCertificationType();
        mRedName = viewerModel.isRedName();
    }
