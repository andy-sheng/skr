...
import com.mi.liveassistant.proto.CommonChannelProto.LiveInfo;
import com.mi.liveassistant.proto.CommonChannelProto.LiveOrReplayItemInfo;
import com.mi.liveassistant.proto.CommonChannelProto.UiTemplateLiveOrReplayInfo;
...
public class ChannelLiveViewModel extends ChannelViewModel<CommonChannelProto.ChannelItem> {
    ...
    protected ChannelLiveViewModel(CommonChannelProto.ChannelItem protoItem) throws Exception {
        super(protoItem);
    }
    ...
    public static class BaseLiveItem extends BaseItem {
        ...
        public String getImageUrl(int sizeType) {
            if (!TextUtils.isEmpty(mImgUrl)) {
                ...
                return AvatarUtils.getAvatarUrlByUidTs(mUser.getUid(), sizeType, mUser.getAvatar());
            }
        }
    ...
    public static class LiveItem extends BaseLiveItem {
        ...
        private String getLiveCoverUrl() {
            if (!TextUtils.isEmpty(mImgUrl)) {
                ...
                return AvatarUtils.getAvatarUrlByUidTs(mUser.getUid(), AvatarUtils.SIZE_TYPE_AVATAR_MIDDLE, mUser.getAvatar());
            }
        }
