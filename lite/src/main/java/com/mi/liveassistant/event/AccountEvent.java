package com.mi.liveassistant.event;
...
public class AccountEvent {
    ...
    public static class LogOffEvent {
        ...
        public static final int EVENT_TYPE_NORMAL_LOGOFF = 1;       // 主动注销
        public static final int EVENT_TYPE_KICK = 2;                // 账号被踢
        public static final int EVENT_TYPE_FORBIDDEN = 3;           // 账号封禁
        public static final int EVENT_TYPE_EXPIRE_LOGOFF = 4;       // 过期注销
