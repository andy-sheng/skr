...
import com.mi.liveassistant.dns.MultiCdnIpSelectionHelper;
...
import com.mi.liveassistant.room.utils.MagicParamUtils;
...
public class StreamerPresenter extends BaseStreamerPresenter<StreamerPresenter.ReconnectHelper,
    ...
    private JSONObject getOptimalKaraOkParams() {
        ...
        try {
            object.put(IStreamer.OPTIMAL_MUSIC_IN_SPEAKER_MODE,
                    PreferenceUtils.getSettingFloat(IStreamer.OPTIMAL_MUSIC_IN_SPEAKER_MODE, 1.0f));
            object.put(IStreamer.OPTIMAL_VOICE_IN_SPEAKER_MODE,
                    PreferenceUtils.getSettingFloat(IStreamer.OPTIMAL_VOICE_IN_SPEAKER_MODE, 1.0f));
            object.put(IStreamer.OPTIMAL_ONLY_VOICE_IN_SPEAKER_MODE,
                    PreferenceUtils.getSettingFloat(IStreamer.OPTIMAL_ONLY_VOICE_IN_SPEAKER_MODE, 1.0f));
            object.put(IStreamer.OPTIMAL_MUSIC_IN_HEADSET_MODE,
                    PreferenceUtils.getSettingFloat(IStreamer.OPTIMAL_MUSIC_IN_HEADSET_MODE, 1.0f));
            object.put(IStreamer.OPTIMAL_VOICE_IN_HEADSET_MODE,
                    PreferenceUtils.getSettingFloat(IStreamer.OPTIMAL_VOICE_IN_HEADSET_MODE, 1.0f));
    ...
    protected static class MyUIHandler extends BaseStreamerPresenter.MyUIHandler<StreamerPresenter> {
        public MyUIHandler(@NonNull StreamerPresenter presenter) {
            super(presenter);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MSG_START_STREAM_FAILED:
                    ...
                    //TODO event notify MSG_START_STREAM_FAILED
                    break;
                default:
                    break;
            }
