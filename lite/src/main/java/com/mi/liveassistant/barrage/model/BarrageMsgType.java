package com.mi.liveassistant.barrage.model;
...
public class BarrageMsgType {
    ...
    public static int[] types = new int[]{
            B_MSG_TYPE_SET_MANAGER, B_MSG_TYPE_CANCEL_MANAGER, B_MSG_TYPE_ROOM_FOUCES_ANCHOR, B_MSG_TYPE_OUTDOOR_FOUCES, B_MSG_TYPE_CANCLE_FOUCES
            , B_MSG_TYPE_GIFT, B_MSG_TYPE_TEXT, B_MSG_TYPE_FORBIDDEN, B_MSG_TYPE_LIKE, B_MSG_TYPE_CANCEL_FORBIDDEN, B_MSG_TYPE_SHARE
            , B_MSG_TYPE_TOP_GET, B_MSG_TYPE_TOP_LOSE, B_MSG_TYPE_JOIN, B_MSG_TYPE_LEAVE, B_MSG_TYPE_ANCHOR_LEAVE, B_MSG_TYPE_ANCHOR_JOIN
            , B_MSG_TYPE_LIVE_START, B_MSG_TYPE_LIVE_END, B_MSG_TYPE_LINE_MIC_BEGIN, B_MSG_TYPE_LINE_MIC_END, B_MSG_TYPE_LINE_VIEWER_BACK
            , B_MSG_TYPE_LINE_VIEWER_LEAVE,B_MSG_TYPE_ANIM, B_MSG_TYPE_LIGHT_UP_GIFT, B_MSG_TYPE_ROOM_BACKGROUND_GIFT, B_MSG_TYPE_TAP_TP_SELL,B_MSG_TYPE_SELL,B_MSG_TYPE_ATTACHMENT,B_MSG_TYPE_GLOBAL_SYS_MSG
            , B_MSG_TYPE_ROOM_SYS_MSG, B_MSG_TYPE_LIVE_OWNER_MSG,B_MSG_TYPE_ADD_SHOP,
            B_MSG_TYPE_COMMEN_SYS_MSG, B_MSG_TYPE_GLABAL_MSG
