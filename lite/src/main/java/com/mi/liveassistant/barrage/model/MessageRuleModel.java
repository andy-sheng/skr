 ...
 */
public class MessageRuleModel implements Serializable {
    ...
    public MessageRuleModel(LiveCommonProto.MsgRule msgRule) {
        if (msgRule != null) {
    ...
    public MessageRuleModel(boolean isRedName, int speakperid) {
        if (isRedName) {
    ...
    public void merge(MessageRuleModel messageRule) {
        if (messageRule != null) {
    ...
    public static MessageRuleModel mergeMessageRule(Map<MessageRuleType, MessageRuleModel> messageRule) {
        if (messageRule != null && messageRule.size() > 0) {
            MessageRuleModel result = null;
