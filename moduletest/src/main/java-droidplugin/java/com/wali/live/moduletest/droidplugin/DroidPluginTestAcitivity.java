...
@Route(path = "/test/DroidPluginTestAcitivity")
public class DroidPluginTestAcitivity extends BaseActivity {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.test_droidplugin_main_layout;
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        mDataList.add(new H("已安装",new InstallView(this)));
        mDataList.add(new H("SdCard",new UninstallView(this)));
